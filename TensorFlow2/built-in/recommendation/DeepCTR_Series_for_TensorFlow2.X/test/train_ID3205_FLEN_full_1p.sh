...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="FLEN_ID3205_for_TensorFlow2.X"
#训练epoch
train_epochs=5
#训练batch_size
batch_size=128
...
do
    ...
    nohup python3 run_flen.py > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done 
wait
#训练结束时间，不需要修改
end_time=$(date +%s)
...
##获取错误信息
#系统错误信息
# error_msg="dnn/BiasAdd/ReadVariableOp"
