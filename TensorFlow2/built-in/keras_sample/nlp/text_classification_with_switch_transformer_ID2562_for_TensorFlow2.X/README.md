...
- 适配昇腾 AI 处理器的实现：skip
   ...
   https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow2/built-in/keras_sample/nlp/text_classification_with_switch_transformer_ID2562_for_TensorFlow2.X
