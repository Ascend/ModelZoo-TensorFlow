...
def parse_args():
    ...
    parser.add_argument('--part_steps', default=1, type=int,
                        help='part_steps')
...
slow_tokenizer = BertTokenizer.from_pretrained(os.path.join(args.data_path,"bert-base-uncased"))
...
eval_path = os.path.join(args.data_path, "eval.json")
...
def create_model():
    ## BERT encoder
    encoder = TFBertModel.from_pretrained(os.path.join(args.data_path,"bert-base-uncased"))
