...
from keras.layers import Input, Add, GlobalAveragePooling2D, Lambda, Dropout, Lambda
from keras import regularizers
# from npu_device.compat.v1.estimator.npu import npu_convert_dropout
...
def BasicBlock(input, planes, dropout, stride=1):
    ...
    out = Lambda(npu_ops.dropout, arguments={'keep_prob':dropout})(out)
