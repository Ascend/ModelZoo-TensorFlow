...
class My_SWA(AveragedOptimizerWrapper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.iterations = backend.variable(0,dtype='int32',name='iterations')
    ...
    def average_op(self, var, average_var, local_apply_state):
        ...
        average_period = self._get_hyper("average_period", tf.dtypes.int32)
        start_averaging = self._get_hyper("start_averaging", tf.dtypes.int32)
