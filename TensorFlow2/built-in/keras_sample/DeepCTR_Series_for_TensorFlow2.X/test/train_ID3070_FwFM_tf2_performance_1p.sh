...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="FwFM_ID3070_for_TensorFlow2.X"
#训练epoch
train_epochs=5
#训练batch_size
batch_size=128
...
##获取错误信息
#系统错误信息
error_msg=" op\[BiasAdd\], ParseJsonCompileInfo, get broadcast_bias_shape error"
