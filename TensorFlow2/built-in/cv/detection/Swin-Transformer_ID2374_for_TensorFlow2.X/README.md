...
**描述（Description）：基于TensorFlow2框架的Swin-Transformer网络训练代码**

<h2 id="概述.md">概述</h2>
-     Swin Transformer是一种新型视觉Transformer，它可以用作计算机视觉的通用backbone
