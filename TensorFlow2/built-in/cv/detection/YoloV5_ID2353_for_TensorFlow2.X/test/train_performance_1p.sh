...
#拷贝数据集txt文件
mkdir ${cur_path}/dataset_perf
cp -r ${data_path}/voc/voc_train_perf.txt ${data_path}/voc/voc_test_perf.txt ${cur_path}/dataset_perf

#修改数据集路径
sed -i "s|voc|${data_path}/voc|g" ${cur_path}/dataset_perf/voc_train_perf.txt
sed -i "s|voc|${data_path}/voc|g" ${cur_path}/dataset_perf/voc_test_perf.txt
...
python3 ./yolo/train.py --n_epochs=${train_epochs} \
                        ...
                        --train_annotations_dir=${cur_path}/dataset_perf/voc_train_perf.txt \
                        --test_annotations_dir=${cur_path}/dataset_perf/voc_test_perf.txt \
