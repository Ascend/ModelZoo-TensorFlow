...
- 开始训练    
    ...
    2. 单卡训练 
        ...
        2.1 配置train_full_1p.sh脚本中`data_path`（脚本路径knowledge_disti_ID2517_for_TensorFlow2.X/test/train_full_1p.sh）,请用户根据实际路径配置，数据集参数如下所示：
...
```
knowledge_disti_ID2517_for_TensorFlow2.X/
