...
# sed -i "s|CONFIG.TRAIN.MAX_ITERS = 15000|CONFIG.TRAIN.MAX_ITERS = 28909|g" config.py
cd configs
...
# sed -i "s|CONFIG.TRAIN.MAX_ITERS = 28909|CONFIG.TRAIN.MAX_ITERS = 15000|g" config.py
cd ../test
