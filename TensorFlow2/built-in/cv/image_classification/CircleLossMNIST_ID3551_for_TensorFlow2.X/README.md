...
- 使用Adam优化器，sparse_categorical_crossentropy损失函数,Accuracy性能评估在MNIST数据进行文本训练。

- 参考论文：

    [https://arxiv.org/pdf/2002.10857.pdf](https://arxiv.org/pdf/2002.10857.pdf)

- 参考实现：

    [https://github.com/yujiacheng333/CircleLossMNIST](https://github.com/yujiacheng333/CircleLossMNIST)
...
## 脚本和示例代码<a name="section08421615141513"></a>
    ...
    |    |—— train_full_1p_static.sh             	 //单卡全量训练脚本(静态shape)
    |    |—— train_performance_1p_static.sh             //单卡性能测试脚本(静态shape)
    ├── configs                          	 //算子黑名单
