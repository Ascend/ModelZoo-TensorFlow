...
def main(_):
  ...
  if FLAGS.do_eval:
    ...
    if not eval_file_exists: # if tf_record file not exist, convert from raw text file. # TODO
  ...
  if FLAGS.do_predict:
    ...
    if not predict_file_exists: # if tf_record file not exist, convert from raw text file. # TODO
