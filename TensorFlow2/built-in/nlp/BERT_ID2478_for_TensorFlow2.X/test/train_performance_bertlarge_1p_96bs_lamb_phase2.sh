...
#基础参数 需要模型审视修改
#网络名称，同目录名称
Network="BERT_ID3224_for_TensorFlow2.X"
#训练batch_size
batch_size=12
eval_batch_size=16
#训练step
...
init_ckpt_path=${data_path}/download/google_pretrained_weights/uncased_L-24_H-1024_A-16/bert_model.ckpt
...
do
    ...
    #xport ASCEND_DEVICE_ID=$RANK_ID
...
DeviceType=`uname -m`
CaseName=${Network}_BertLarge_phase2_bs${BatchSize}_${RANK_SIZE}'p'_'perf'
