...
#基础参数 需要模型审视修改
#网络名称，同目录名称
Network="BERT_ID3226_for_TensorFlow2.X"
#训练batch_size
batch_size=24
eval_batch_size=16
#训练step
...
init_ckpt_path=${data_path}/download/google_pretrained_weights/uncased_L-12_H-768_A-12/bert_model.ckpt
...
DeviceType=`uname -m`
CaseName=${Network}_BertBase_phase2_bs${BatchSize}_${RANK_SIZE}'p'_'perf'
