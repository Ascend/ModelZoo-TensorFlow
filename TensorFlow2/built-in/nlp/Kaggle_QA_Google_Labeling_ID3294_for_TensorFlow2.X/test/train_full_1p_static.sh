...
batch_size=8
#网络名称，同目录名称
Network="Kaggle_QA_Google_Labeling_ID3294_for_TensorFlow2.X"
#Device数量，单卡默认为1
RANK_SIZE=1
#训练epoch，可选
train_epochs=20
...
#train_steps=50000
#学习率
log_steps=152 # 0.2 * steps_per_epoch
#参数配置
data_path=""
...
start=$(date +%s)
nohup python3 q-a-labeling-bert-base-huggingface-transformer.py \
   --data_path=${data_path} \
