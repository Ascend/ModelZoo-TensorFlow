...
eval_batch_size=4
batch_size=24
average_sequences_per_sample=2
#训练step
train_steps=1000
#训练epoch
...
do
    ...
    --attention_with_dropout_v3=True \
        --over_dump=${over_dump} \
...
FPS=`awk 'BEGIN{printf "%.2f\n",'${single_batch_step_sec}'*'${batch_size}'*'${average_sequences_per_sample}'}'`
#打印，不需要修改
...
DeviceType=`uname -m`
#用例名称
CaseName=${Network}_bs${BatchSize}_${RANK_SIZE}'p_packed'_'acc'
