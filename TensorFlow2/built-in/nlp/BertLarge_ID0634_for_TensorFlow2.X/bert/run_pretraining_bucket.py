...
def npu_config():
  ...
  npu_device.global_options().experimental.multi_branches_config.dynamic_dims = "192,64,192,64,192,64,192,76,192,76,192,76,192,1;" \
                                                                                ...
                                                                                "27,448,27,448,27,448,27,76,27,76,27,76,27,1"
...
def get_pretrain_dataset_fn(input_file_pattern,
  ...
  def _dataset_fn(ctx=None):
    ...
    dataset = input_pipeline.create_pretrain_dataset_bucket(
        input_patterns=input_patterns,
        seq_length=seq_length,
        max_tockens_num=max_tockens_num,
...
def run_customized_training(strategy,
  ...
  mlp_log.mlperf_print('max_tockens_num', max_tockens_num)
  mlp_log.mlperf_print('seq_len_buckets', seq_len_buckets)
  ...
  def _get_pretrain_model():
    ...
    pretrain_model, core_model, core_pretrain_model = bert_models.pretrain_model_bucket(
...
def run_bert_pretrain(strategy, custom_callbacks=None):
  ...
  _, masked_lm_accuracy, run_steps = run_customized_training(
      ...
      max_tockens_num=FLAGS.max_tockens_num,
      seq_len_buckets=FLAGS.seq_len_buckets,
