...
collect_result()
{
	...
	echo Accuracy: $Accu  >> $testcase_dir/precision_results.log
	#print results
    echo ""
...
echo ""
    ...
    Example:
     ./benchmark_tf.sh --batchSize=1 --modelPath=/home/liukongyuan/ID0122_facenet/pure/model/facenet.om --dataPath=$dataset_bin/data_image_bin/ --modelType=facenet --imgType=rgb"
#    '
    exit 1
fi
loopNum=1
