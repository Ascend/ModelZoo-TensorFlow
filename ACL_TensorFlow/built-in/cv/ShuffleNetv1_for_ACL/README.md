...
- Pb模型转换为om模型
  ...
  下载本报告训练的shuffenetv1的pb模型: [Repo of train](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/shufflenetv1/ShuffleNet_ID0184_for_TensorFlow)
  
  [pb模型下载链接](https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/003_Atc_Models/modelzoo/Official/cv/ShuffleNetv1_for_ACL.zip)

  由于经过训练的检查点将批量大小固定为**96**，因此atc输入形状需要设置**“输入：96224224.3”**
  ```
