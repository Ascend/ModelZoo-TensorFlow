...
- convert pb to om
  ...
  For Ascend710:
  ```
  atc --model=googlenet_tf.pb --framework=3 --output=googlenet_tf_aipp --output_type=FP32 --soc_version=Ascend710 --input_shape="input:1,224,224,3" --log=info --insert_op_conf=googlenet_tf_aipp.cfg
  ```
...
| offline Inference| Ascend710     | 50K images | 70.1 %/ 89.6% |
