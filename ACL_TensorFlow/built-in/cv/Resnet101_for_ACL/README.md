...
此链接提供ResNet101 TensorFlow模型在NPU上离线推理的脚本和方法
...
**Pb模型转换为om模型**
  ...
  [pb模型下载链接](https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/003_Atc_Models/modelzoo/Official/cv/Resnet101_for_ACL.zip)
