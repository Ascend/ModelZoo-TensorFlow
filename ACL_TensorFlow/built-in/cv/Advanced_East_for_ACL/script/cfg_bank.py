...
assert max_train_img_size in [256, 384, 512, 640, 736, 832], \
    'max_train_img_size must in [256, 384, 512, 640, 736, 832]'
...
origin_image_dir_name = 'pitures/'
origin_txt_dir_name = 'txts/'
