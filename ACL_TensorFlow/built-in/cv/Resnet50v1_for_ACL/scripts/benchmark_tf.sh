...
om_name=$cur_dir/../resnet50v1_tf_1batch.om
batchsize=1
...
#post process
python3 $cur_dir/imagenet_accuarcy_cal.py --infer_result $cur_dir/$output_dir/$model_name --label $cur_dir/ILSVRC2012val-label-index.txt --offset 0
