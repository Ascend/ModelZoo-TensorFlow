...
- convert pb to om
  ...
  ```
  atc --model=alexnet_tf.pb --framework=3 --output=alexnet_tf_aipp --output_type=FP32 --soc_version=Ascend710 --input_shape="input:1,224,224,3" --log=info --insert_op_conf=alexnet_tf_aipp.cfg
  ```
...
| offline Inference| Ascend710     | 50K images | 59.9 %/ 82.0% |
