...
cd modelzoo/built-in/ACL_TensorFlow/Official/cv/EfficientNet_B0_for_ACL
```
...
- convert pb to om
  ...
  For Ascend710:
  ```
  atc --model=efficientnetb0_tf.pb --framework=3 --output=efficientnetb0_tf_aipp --output_type=FP32 --soc_version=Ascend710 --input_shape="input:1,224,224,3" --log=info --insert_op_conf=efficientnetb0_tf_aipp.cfg
  ```
...
| offline Inference| Ascend710     | 50K images | 76.3 %/ 92.9% |
