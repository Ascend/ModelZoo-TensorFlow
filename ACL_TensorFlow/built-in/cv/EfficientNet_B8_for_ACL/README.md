...
# EfficientNet_B8 Inference for Tensorflow 

This repository provides a script and recipe to Inference of the EfficientNet_B8 model.
...
cd modelzoo/built-in/ACL_TensorFlow/Official/cv/EfficientNet_B8_for_ACL
```
