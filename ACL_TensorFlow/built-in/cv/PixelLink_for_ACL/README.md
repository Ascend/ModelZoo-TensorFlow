...
# PixelLink TensorFlow离线推理

此链接提供PixelLink TensorFlow模型在NPU上离线推理的脚本和方法
...
1. 请自行下载Icdar2015测试数据集（包含500张图片）

2. 将图片放到 'scripts/ch4_test_images'目录下
...
**Pb模型转换为om模型**
  ...
  [pb模型下载链接](https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/003_Atc_Models/modelzoo/Official/cv/PixelLink_for_ACL.zip)
