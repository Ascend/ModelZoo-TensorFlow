    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="bert"):
            with tf.variable_scope("embeddings"):
                ...
                # but use stype of factorized embedding parameterization from albert_zh. add by brightmart, 2019-09-28
            ...
            with tf.variable_scope("encoder"):
                ...
                if ln_type == 'postln' or ln_type is None:  # currently, base or large of albert_zh used post-LN structure
                ...
                else:  # xlarge or xxlarge of albert_zh, used pre-LN structure
                    ...
                    self.all_encoder_layers = prelln_transformer_model(
                        # change by brightmart, 4th, oct, 2019.
                        # pre-Layer Normalization can converge fast and better.
...
def embedding_lookup_factorized(input_ids,  # Factorized embedding parameterization provide by albert_zh
                                vocab_size,
                                hidden_size,
                                embedding_size=128,
                                initializer_range=0.02,
                                word_embedding_name="word_embeddings",
                                use_one_hot_embeddings=False):
    """Looks up words embeddings for id tensor, but in a factorized style followed by albert_zh.
...
def transformer_model(input_tensor,
    ...
    for layer_idx in range(num_hidden_layers):
        ...
        # share all parameters across layers. add by brightmart, 2019-09-28.
        # previous it is like this: "layer_%d" % layer_idx
