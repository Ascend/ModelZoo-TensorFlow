...
class DenseEvaluator(Callback):
    ...
    """
        ...
        y_pred = self.inference_model.predict(self.data, batch_size=128)#batch_size=128
        net = self.inference_model
        net.save('net.h5')
        input_x = self.data
        ...
        input_x_1.tofile("input_x_1.bin")
        input_x_2.tofile("input_x_2.bin")
        input_x_3.tofile("input_x_3.bin")
        input_x_4.tofile("input_x_4.bin")
        input_x_5.tofile("input_x_5.bin")
        input_x_6.tofile("input_x_6.bin")
        input_x_7.tofile("input_x_7.bin")
        input_x_8.tofile("input_x_8.bin")
