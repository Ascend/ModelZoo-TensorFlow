...
class Abstract_Model_Class(ABC):
    ...
    def __init__(self, modelName, inputDims, outputDims, expName, numVids, loadWeights='pretrained_UCF101', preprocMethod='default', clipLength=-1, numEpochs=1, batchSize=1, numClips=-1, numGpus=1, train=0, modelAlpha=1, inputAlpha=1, dropoutRate=0.5, freeze=0, verbose=1):
