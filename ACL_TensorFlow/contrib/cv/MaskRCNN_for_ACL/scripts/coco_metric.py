...
class MaskCOCO(COCO):
  ...
  def loadRes(self, detection_results, include_mask, is_image_mask=False):
    ...
    if predictions:
      ...
      #print('1111111111set(image_ids)',set(image_ids))
      #print('2222222222222(set(image_ids) & set(self.getImgIds()))',  set(self.getImgIds()))
...
def generate_segmentation_from_masks(masks,
  ...
  for mask_ind, mask in enumerate(masks):
    ...
    if is_image_mask:
      ...
      #print("xxxxx",x_0,x_1,y_0,y_1)
      #print("refref---",ref_box[0],ref_box[2],ref_box[1],ref_box[3])
