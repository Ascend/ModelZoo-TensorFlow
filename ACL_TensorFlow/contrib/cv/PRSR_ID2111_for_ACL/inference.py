...
save_samples(gen_hr_imgs, './outimg/ckpt_generate_imgs' + '.jpg')
save_samples(np_hr_imgs, './outimg/ckpt_hr_imgs' + '.jpg')
...
img1 = cv2.imread("./outimg/generate_imgs.jpg")
img2 = cv2.imread("./outimg/hr_imgs.jpg")
