...
infer_test()
{
    ...
    ./benchmark --dataDir $dataPath --om $modelPath --batchSize $batchSize --modelType $modelType --imgType $imgType --deviceId $deviceId --loopNum $loopNum --useDvpp $useDvpp
        ...
        echo "./benchmark --dataDir $dataPath --om $modelPath --batchSize $batchSize --modelType $modelType --imgType $imgType --deviceId $deviceId --loopNum $loopNum --innum $innum --suffix1 $suffix1 --suffix2 $suffix2"
