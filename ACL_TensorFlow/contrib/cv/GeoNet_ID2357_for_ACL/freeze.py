...
def freeze_graph(input_checkpoint, output_graph):
    output_node_names = "pose_net/mul"
...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string('input_checkpoint', '/home/yhm/output/ckpt/pose_depth_old/model-180000', "input checkpoint.")
    tf.flags.DEFINE_string('output_graph', '/home/yhm/output/ckpt/pb/model-180000.pb', "output_graph.")
