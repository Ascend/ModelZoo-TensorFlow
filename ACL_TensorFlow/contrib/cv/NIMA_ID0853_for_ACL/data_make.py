...
base_images_path = r'./AVA_DATASET_TEST/image/'
ava_dataset_path = r'./AVA_DATASET_TEST/AVA.txt'
...
for step in range(int(image_num/batch_size)):
    ...
    X_batch.tofile("./xdata/"+str(step)+".bin")
    label += y_batch.tolist()
label = np.array(label)
np.save( "./ydata/imageLabel.npy", label)
