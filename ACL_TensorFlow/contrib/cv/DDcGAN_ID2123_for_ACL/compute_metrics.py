...
while(epochnum <= 3):
    ...
    resultFoldName = './results_image/2736'
    ...
    for i in range(imgNum):
        ...
        print(viFoldName + str(i + 1) + '.bmp')
        print(irFoldName + str(i + 1) + '.bmp')
    ...
    print('SSIM: %s,EN: %s, SD: %s, CC: %s, SF: %s, VIF: %s' % (
        SSIM_SUM / 3, EN_SUM / 3, SD_SUM / 3, CC_SUM / 3,  SF_SUM / 3, 
        VIF_SUM / 3))
