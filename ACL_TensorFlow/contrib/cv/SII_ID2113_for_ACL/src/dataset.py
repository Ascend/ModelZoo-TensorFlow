...
class SVHN(object):
    def __init__(self, flags, dataset_name):
        ...
        self.svhn_train_path = os.path.join(current_path+'/../Data/', self.dataset_name,'train_32x32.mat')
        self.svhn_val_path = os.path.join(current_path+'/../Data/', self.dataset_name, 'test_32x32.mat')
        self._load_svhn()
    ...
    def train_next_batch(self, batch_size):
        ...
        batch_imgs_ = [utils.random_flip(
            utils.transform(resize(batch_imgs[idx],output_shape=(self.image_size[0], self.image_size[1]))))
