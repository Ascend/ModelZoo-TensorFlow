...
import matplotlib as mpl
  ...
  # or whatever other backend that you want to solve Segmentation fault (core dumped)
...
class DCGAN(object):
    ...
    def generator(self, data, name='g_', is_reuse=False):  #256*100
    ...
    def sample_z(self, num=64): #(256,100)
