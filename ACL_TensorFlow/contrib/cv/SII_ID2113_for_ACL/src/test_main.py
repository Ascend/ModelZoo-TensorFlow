...
tf.flags.DEFINE_string('dataset', 'svhn', 'dataset name for choice [celebA|svhn], default: celebA')
...
tf.flags.DEFINE_string('mask_type', 'pattern', 'mask type choice in [center|random|half|pattern], default: center')
...
tf.flags.DEFINE_string('load_model', '20211215-0005',
                       'saved DCGAN model that you wish to test, (e.g. 20180704-1736), default: None')
tf.flags.DEFINE_bool('is_test',False,'test to generate pb file')
