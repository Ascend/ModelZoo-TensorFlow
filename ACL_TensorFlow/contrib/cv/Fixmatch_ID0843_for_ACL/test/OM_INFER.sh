...
if [[ $1 == --help || $1 == -h ]];then
    ...
    --masme_path             set the path of masme after build, e.g. --masme_path=/home/HwHiAiUser/msame/tools/msame/out
    --model                  set model place, e.g. --model="/home/HwHiAiUser/fixmatch310.om"
    --input                  set the floder or file of BIN, e.g. --input="/home/HwHiAiUser/input_bin"
    --output                 set the place of inference result floder, e.g. --output="/home/HwHiAiUser/msame/out/"
