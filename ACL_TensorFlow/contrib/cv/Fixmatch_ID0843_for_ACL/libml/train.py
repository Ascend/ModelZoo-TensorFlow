...
class ClassifySemi(Model):
    ...
    def train(self, train_nimg, report_nimg):
        ...
        train_unlabeled = train_unlabeled.batch(batch, drop_remainder=True).prefetch(16).make_one_shot_iterator().get_next()
    ...
    def cache_eval(self):
        ...
        def collect_samples(dataset, name):
            ...
            it = dataset.batch(1, drop_remainder=True).prefetch(16).make_one_shot_iterator().get_next()
            images, labels = [], []
            while 1:
                try:
