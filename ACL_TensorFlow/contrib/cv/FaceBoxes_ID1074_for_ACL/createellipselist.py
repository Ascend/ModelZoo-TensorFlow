...
ap.add_argument( "--is_show", required=False, default=True, help="show result or not?")
...
ap.add_argument( "--result", required=False,default='./result4',help="dir to write result")
args = ap.parse_args()
