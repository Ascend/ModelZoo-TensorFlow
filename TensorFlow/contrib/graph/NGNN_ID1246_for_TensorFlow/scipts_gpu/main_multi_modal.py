    ...
    with tf.Session() as sess:
        ...
        for epoch in range(15):
                ...
                if size_ >= batch_size:
                    ...
                    if i % test_interval == 0:
                        ...
                        if auc > best_auc:
                            ...
                            #tf.io.write_graph(sess.graph, 'trained_graph/ckpt_gpu', 'graph.pbtxt', as_text=True)
                            # get_log()
            ...
            if accurancy > best_accurancy:
                ...
                tf.io.write_graph(sess.graph, 'graph_1/ckpt_gpu', 'graph.pbtxt', as_text=True)
                #get_log()
