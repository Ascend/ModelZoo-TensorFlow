...
def train():
    ...
    if args.dataset_type == 'llff':
        images, poses, bds, render_poses, i_test = load_llff_data(data_dir, args.factor,
                                                                  recenter=True, bd_factor=.75,
                                                                  spherify=args.spherify)
        hwf = poses[0, :3, -1]
        poses = poses[:, :3, :4]
        print('Loaded llff', images.shape,
              render_poses.shape, hwf, data_dir)
        ...
        images, poses, render_poses, hwf, i_split = load_blender_data(
            data_dir, args.half_res, args.testskip)
    ...
    for i in range(start, N_iters):
        ...
        if i % args.i_print == 0 or i < 10:
            ...
            print(timeshow+': ', expname, i, psnr.numpy(), loss.numpy(), global_step.numpy())
            print('iter time {:.05f} s'.format(dt))
    ...
    # for f in files:
    #     if(os.path.isfile(model_dir+'/'+f)):
    #         filelist.append(f)
    # for f1 in files:
    #     print(f1)
    # modelfiles = os.listdir("./logs/fern_test")
    # for f in modelfiles:
    #     if(os.path.isfile("./logs/fern_test"+'/'+f)):
    #         modellist.append(f)
    # for f1 in modelfiles:
    #     print(f1)
