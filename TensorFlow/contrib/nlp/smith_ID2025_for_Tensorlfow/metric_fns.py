...
def metric_fn_finetune(predicted_class, labels, siamese_example_loss,
  ...
  Returns:
    The metrics dict to be used in the evaluation metrics.
  """
  tf.logging.info("***** predicted_class %s *****", str(predicted_class))
  tf.logging.info("***** labels %s *****", str(labels))
  tf.logging.info("***** siamese_example_loss %s *****", str(siamese_example_loss))
  tf.logging.info("***** is_real_example %s *****", str(is_real_example))
