...
flags.DEFINE_string(
    "out_log_dir", None,
    "Directory with log files, comma separated or single directory. ")
...
class _LogSessionRunHook(tf.train.SessionRunHook):
    def __init__(self, global_batch_size, num_accumulation_steps, display_every=10, hvd_rank=-1):
        ...
        self.num_accumulation_steps = num_accumulation_steps #1
    ...
    def after_run(self, run_context, run_values):
        ...
        if update_step:
            ...
            sent_per_sec = self.global_batch_size / dt * FLAGS.iterations_per_loop   #100   
                ...
                if (tf.flags.FLAGS.npu_bert_loss_scale == 0) and (FLAGS.manual_fp16 or FLAGS.use_fp16):
                    print(
                        ...
                        (self.hvd_rank, print_step, sent_per_sec, mlm_loss, nsp_loss, total_loss, avg_loss_step, lr,
                         loss_scaler, custom_arg), flush=True)
                else:
                    print(
            ...
            #pass
                ...
                if (tf.flags.FLAGS.npu_bert_loss_scale == 0) and (FLAGS.manual_fp16 or FLAGS.use_fp16):
                    print(
                        'Step = %6i Throughput = %4.4f  time = %4.4f MLM Loss = %10.4e NSP Loss = %10.4e Loss = %9.6f Average Loss = %9.6f LR = %6.4e Loss scale = %6.4e isFinite = %6i' %
                        (print_step, sent_per_sec, dt, mlm_loss, nsp_loss, total_loss, avg_loss_step, lr, loss_scaler,
                         custom_arg), flush=True)
                else:
                    print(
...
if __name__ == "__main__":
    ...
    flags.mark_flag_as_required("out_log_dir")
