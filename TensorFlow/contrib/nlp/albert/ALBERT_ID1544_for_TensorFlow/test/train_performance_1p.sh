...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="ALBERT_ID1544_for_TensorFlow"
#训练epoch
epoch=2
#训练batch_size
RANK_SIZE=1
...
do
    ...
    nohup python3 run_squad_v2.py \
        --output_dir=${data_path}/output_base_v2 \
        --input_dir=${data_path}/squad_v2 \
        --model_dir=${data_path}/albert_base_v2 \
        --do_lower_case \
        --max_seq_length=384 \
        --doc_stride=128 \
        --max_query_length=64 \
