...
""" Inferance on a3c model with lstm
"""
...
def parse_args():
    ...
    parser.add_argument('--input_model', default='../om_model/a3c_alien_model.om',
...
def main():
    ...
    for i in range(test_num):
        ...
        while True:
            ...
            c_state, h_state, a = model.inference([s, c_state, h_state])
            a = int(a[0])
            s_, r, done, info = env.step(a)
            score += r
            frame += 1
            s = s_
            if done or frame>2000:
                break
