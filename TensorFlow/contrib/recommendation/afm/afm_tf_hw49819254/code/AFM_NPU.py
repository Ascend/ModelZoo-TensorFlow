...
def parse_args():
    ...
    parser.add_argument('--data_url', nargs='?', default='../data/',
                        help='dataset  path type: train, evaluate.')
    parser.add_argument('--train_url', nargs='?', default='../pretrain/',
    ...
    parser.add_argument('--batch_size', type=int, default=4096,  # 4096, 8192  16384
                        help='Batch size.')
    ...
    parser.add_argument('--hidden_factor0',  nargs='?', default='8',
                        help='Number of hidden factors.')
    parser.add_argument('--hidden_factor1',  nargs='?', default='256',
                        help='Number of hidden factors.')
...
class AFM(BaseEstimator, TransformerMixin):
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():  # , tf.device('/cpu:0'):
            ...
            if self.attention:
                ...
                self.attention_out = npu_ops.dropout(self.attention_out, self.dropout_keep[0]) # dropout
            ...
            self.AFM = npu_ops.dropout(self.AFM, self.dropout_keep[1]) # dropout
    ...
    def _init_session(self):
        ...
        config.graph_options.rewrite_options.remapping = RewriterConfig.OFF  # 关闭remap开关d
    ...
    def evaluate(self, data):  # evaluate the results for an input set
        ...
        while len(batch_xs['X']) > 0:
            ...
            if batch_index == 0:
                ...
                #print("shape of batch_out: ", np.shape(batch_out), "num_batch: ", num_batch)
                if(num_batch<self.batch_size):
                    batch_out=batch_out[0:num_batch]
