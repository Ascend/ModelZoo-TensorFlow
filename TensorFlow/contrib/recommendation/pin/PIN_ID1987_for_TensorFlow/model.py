...
class Model:
    ...
    def __init__(self, batch_size, input_dim, num_fields, output_dim=1, init_type='xavier', l2_embed=0, loss_type='log_loss',
    ...
    def def_placeholder(self, train_flag=False):
        with tf.variable_scope('input'):
            self.inputs = tf.placeholder(dtype=tf.int32, shape=[self.batch_size, self.num_fields], name='inputs')
            self.labels = tf.placeholder(dtype=tf.float32, shape=[self.batch_size, self.output_dim], name='labels')
            if train_flag:
...
class PIN(Model):
    def __init__(self, batch_size,input_dim, num_fields, embed_size=10, sub_nn_layers=None, nn_layers=None, output_dim=1,
                 ...
                 loss_mode='mean'):
        Model.__init__(self,batch_size, input_dim, num_fields, output_dim, init_type, l2_embed, loss_type, pos_weight, num_shards,
