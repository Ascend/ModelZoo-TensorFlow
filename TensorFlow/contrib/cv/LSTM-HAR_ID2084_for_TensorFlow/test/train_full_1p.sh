...
if [ x"${modelarts_flag}" != x ];
then
    python3.7 ./config_dataset_HAR_6_classes.py --data_path=${data_path}/ --output_path=${output_path}/
else
    python3.7 ./config_dataset_HAR_6_classes.py --data_path=${data_path}/ --output_path=${output_path}/ &> ${print_log}
fi
