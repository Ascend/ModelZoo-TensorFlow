...
# os.system('cp -r /home/qyy/MassFac/nn_grad.py /home/ma-user/miniconda3/envs/TensorFlow-1.15-arm/lib/python3.7/site-packages/tensorflow_core/python/ops/nn_grad.py')
...
def main(args):
    with compat.forward_compatibility_horizon(2019, 5, 1):
        ...
        # args.data_dir = '/home/qyy/MassFac/dataset/casia-112x112'
        # args.save_dir = '/home/qyy/MassFac/models/'
        args.save_dir = './models/facenet_ms_mp'
        args.random_crop = 1
        args.random_flip=1
...
def sample_people(dataset, class_indices, people_per_batch, images_per_person):
    ...
    #class_index：第几个文件夹
    #nrof_images_in_class：文件夹里文件的个数
    #sample_index：1-6
    image_paths = []
    num_per_class = []
    sampled_class_indices = []
    #pdb.set_trace()
    # Sample images from these classes until we have enoug
    if sample_index == 0:
        np.random.shuffle(class_indices)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--pretrained_model', type=str,
                        ...
                        default='./models-softmax/20211223-225501/model-20211223-225501.ckpt-60000')
    parser.add_argument('--data_dir', type=str,
                        help='Path to the data directory containing aligned face patches. Multiple directories are separated with colon.',
                        default='/home/qyy/MassFac/dataset/casia-112x112')
    ...
    # parser.add_argument("--modelarts_data_dir", type=str, default="/home/qyy/MassFac/dataset/")
    # parser.add_argument("--modelarts_result_dir", type=str, default="/home/qyy/MassFac/result")
