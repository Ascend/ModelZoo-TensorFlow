...
#from lib import help_modelarts
import pdb
#profiling_dir = "/home/qyy/MassFac/profiling/"
...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        with tf.device("/cpu:0"):
            ...
            # !
            softmax_dataset = softmax_dataset.prefetch(buffer_size=100)
        ...
        #custom_op.parameter_map["profiling_options"].s = tf.compat.as_bytes(
            #'{"output":profiling_dir,"task_trace":"on","training_trace":"on","fp_point":"resnet_model/conv2d/Conv2Dresnet_model/batch_normalization/FusedBatchNormV3_Reduce","bp_point":"gradients/AddN_70"}')
...
def parse_arguments(argv):
    ...
    parser.add_argument('--models_base_dir', type=str,
        help='Directory where to write trained models and checkpoints.', default='/home/qyy/MassFac/models-softmax')
    ...
    parser.add_argument('--data_dir', type=str,
        ...
        default='/home/qyy/MassFac/dataset/webface-112x112')
    ...
    parser.add_argument('--learning_rate_schedule_file', type=str,
        help='File containing the learning rate schedule that is used when learning_rate is set to to -1.', default='/home/qyy/MassFac/lr_coco.txt')
