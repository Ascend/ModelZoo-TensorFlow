...
flags.DEFINE_integer("num", 50, "number of channels")
...
def main(_):
    ...
    for ep in range(n_epochs):
        ...
        for epi in range(n_episodes):
            ...
            if (epi + 1) % FLAGS.num == 0:
                print('[epoch {}/{} , episode {}/{}] => loss : {:.5f} , acc: {:.5f} ,traintime: {:.3f}'.format(ep + 1, n_epochs, epi + 1,
                                                                                         n_episodes, ls, ac, (time.time()-start_time)))
