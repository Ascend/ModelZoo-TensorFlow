...
from help_modelarts import obs_checkpoint2modelarts
...
if __name__ == '__main__':
    ...
    work_dir = os.getcwd()    # /cache 3T
    print("===>>>code_dir:{}, work_dir:{}".format(code_dir, work_dir))

    parser = argparse.ArgumentParser()
    parser.add_argument("--train_url", type=str, default="./output")
    parser.add_argument("--data_url", type=str, default="./data/omniglot")
    parser.add_argument("--checkpoint_url", type=str, default="obs://prototypical/checkpoint")
    parser.add_argument("--modelarts_data_dir", type=str, default="/cache/data/omniglot")
    parser.add_argument("--modelarts_checkpoint_dir", type=str, default="/cache/checkpoint")
    ...
    ## copy checkpoint from obs to modelarts
    obs_checkpoint2modelarts(config)
