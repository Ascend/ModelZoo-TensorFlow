...
from networks import inception_resnet_v1 as inception_net
from networks import resface as resface
import pdb
...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        with tf.device("/cpu:0"):
            ...
            softmax_dataset = softmax_dataset.map(_parse_function,num_parallel_calls=8)
            softmax_dataset = softmax_dataset.batch(args.num_gpus*single_batch_size,drop_remainder=True)
                  ...
                  with slim.arg_scope([slim.model_variable, slim.variable], device="/cpu:0"):
                    with tf.variable_scope(tf.get_variable_scope()) as var_scope:
                        ...
                        if args.loss_type == 'softmax':
                            ...
                            print('!!!!!!!!!!!!!!!!!!!!!')
                            #print(type(cross_entropy_mean))
                            print(type(regularization_losses))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--network', type=str,
        help='which network is used to extract feature.',default='mobilenet')
    parser.add_argument('--data_dir', type=str,
        help='Path to the data directory containing aligned face patches. Multiple directories are separated with colon.',
        default='/home/ma-user/modelarts/user-job-dir/MassFac/dataset/lfw-112x112')
    parser.add_argument('--list_file', type=str,
        help='Image list file')
    parser.add_argument('--model_def', type=str,
        help='Model definition. Points to a module containing the definition of the inference graph.', default='models.inception_resnet_v1')
    parser.add_argument('--max_nrof_epochs', type=int,
        help='Number of epochs to run.', default=100)#!100
    ...
    parser.add_argument('--epoch_size', type=int,
        help='Number of batches per epoch.', default=600)#!600
    parser.add_argument('--alpha', type=float,
        help='Margin for cos margin.', default=0.25)
    ...
    parser.add_argument('--learning_rate_decay_epochs', type=int,
        help='Number of epochs between learning rate decay.', default=100)#!100
    ...
    parser.add_argument('--learning_rate_schedule_file', type=str,
        help='File containing the learning rate schedule that is used when learning_rate is set to to -1.', default='/home/ma-user/modelarts/user-job-dir/MassFac/lr_coco.txt')
    parser.add_argument("--train_url", type=str, default="./output")
    parser.add_argument("--data_url", type=str, default="/home/ma-user/modelarts/user-job-dir/MassFac/dataset/lfw-112x112")
    parser.add_argument("--modelarts_data_dir", type=str, default="/home/ma-user/modelarts/user-job-dir/MassFac/dataset/")
    parser.add_argument("--modelarts_result_dir", type=str, default="/home/ma-user/modelarts/user-job-dir/MassFac/MassFac/result")
...
if __name__ == '__main__':
    ...
    #print("--------config--------")
        ...
        #bash_header = os.path.join(code_dir, 'train_softmax.sh')
    ...
    mox.file.copy_parallel(src_url="models/facenet_ms_mp/",
                           dst_url="obs://qyy-unet/MassFace-master/train/models/facenet_ms_mp/")
    #dst_url="obs://2021-buckets-test2/MassFac/train/models/facenet_ms_mp/")
