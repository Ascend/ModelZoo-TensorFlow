...
def obs_data2modelarts(config):
    ...
    """
    obs_checkpiont_dir=os.path.join(config.data_url,'checkpiont')
    ...
    mox.file.copy_parallel(src_url=obs_checkpiont_dir, dst_url=config.modelarts_result_dir)
...
def modelarts_result2obs(FLAGS):
    ...
    print("===>>>Copy Event or Checkpoint from modelarts dir:{} to obs:{}".format(FLAGS.model_dir, obs_result_dir))
