    ...
    try:
        for epoch in range(epochs):
            ...
            for step in range(int(img_N / batch_size)):
                ...
                if (step + 1) % 10 == 0:
                    print(
                        'Epoch %d, step %d, train_loss = %.4f, pixel_accuracy = %.2f, mean_accuracy = %.2f, miou = %.2f, TimeHistory = %.4f' % (
                            epoch + 1, step + 1, tra_loss, p_acc, m_acc, miou, duration))
                    duration = 0
