...
#修改路径
sed -i "s#/home/ma-user/modelarts/inputs/data_url_0#${data_path}#" ./model/rgbd.py
...
# 提取所有loss打印信息
grep "loss" ${print_log} | awk '{print $2}' > ./test/output/${ASCEND_DEVICE_ID}/my_output_loss.txt
