...
class MTV:
    def __init__(self, view_shape, batch_size, ft=False, reg_constant1 = 1.0, reg_constant2 = 1.0, reg = None, \
        ...
        # normalize        
        self.Coef = (self.Coef - tf.compat.v1.diag(tf.compat.v1.diag_part(self.Coef)))

        self.Coef_1 = (self.Coef_1 - tf.compat.v1.diag(tf.compat.v1.diag_part(self.Coef_1)))
        self.Coef_2 = (self.Coef_2 - tf.compat.v1.diag(tf.compat.v1.diag_part(self.Coef_2)))
        ...
        self.optimizer_ae = tf.compat.v1.train.AdamOptimizer(learning_rate=self.lr).minimize(self.reconst_loss)
        # session
