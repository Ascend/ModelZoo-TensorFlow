...
parser.add_argument('--epoch', type=int, default=35, help='# of epochs')
parser.add_argument('--init_epoch', type=int, default=15, help='# of epochs with init lr.')
...
d_loss = d_loss_gan + gp * 100.0 + xa_loss_att * 10.0
