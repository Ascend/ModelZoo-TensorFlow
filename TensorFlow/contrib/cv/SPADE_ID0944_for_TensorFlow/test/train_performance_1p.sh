...
cp ${data_path}/model/* ~/.keras/models
train_epochs=3
batch_size=1
python3.7 main.py --batch_size=${batch_size} --train_epochs=${train_epochs} --use_npu=${use_npu} --data_path=${data_path} --output_path=${output_path} 2>&1 | tee ${print_log}
