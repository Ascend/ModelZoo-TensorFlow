...
def eval():
  ...
  model.load_weights('checkpoints/keras/struc_vrnn')
  model.summary()
  model.evaluate(x=test_dataset,verbose=1,steps=100)
...
if __name__ == '__main__':
  ...
  K.set_session(sess)
  eval()
  save_sess = K.get_session()
  saver = tf.train.Saver()
  saver.save(save_sess,"checkpoints/session/session_struc_vrnn.ckpt")
  save_sess.close()
