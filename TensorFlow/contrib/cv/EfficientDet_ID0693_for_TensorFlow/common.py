...
def parse_args(args):
    ...
    Parse the arguments.
    """
    parser.add_argument('--model_path', help='path to tfrecord', default='/home/dingwei/efficientdet/checkpoints/pascal_13_0.3418_0.5143.h5')
    parser.add_argument('--data_path', help='path to dataset', default='/home/dataset/VOCdevkit/VOC2007')
