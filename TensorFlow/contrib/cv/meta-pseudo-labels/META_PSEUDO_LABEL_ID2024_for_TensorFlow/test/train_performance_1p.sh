...
do
	...
	--uda_temp=0.7 \
	--uda_threshold=0.6 \
	--uda_weight=8	>  ${cur_path}/test/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log   2>&1
	...
	--uda_temp=0.7 \
	--uda_threshold=0.6 \
	--uda_weight=8	>  ${cur_path}/test/output/${ASCEND_DEVICE_ID}/eval_${ASCEND_DEVICE_ID}.log   2>&1
