...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="CycleGAN_ID0716_for_TensorFlow"
#训练epoch
train_epochs=2
#训练batch_size
batch_size=1
...
do
    ...
    python3 train.py \
	--result=./result \
	--dataset=${data_path}/data/tfrecords \
	--chip=npu \
	--platform=apulis \
	--train_epochs=${train_epochs} \
	--step_per_epoch=${train_steps} > ${cur_path}test/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
