...
def read_all_data(actions, seq_length_in, seq_length_out, data_dir, one_hot):
    ...
    dim_to_ignore=datadic["dim_to_ignore"]
    dim_to_use=datadic["dim_to_use"]
    # Normalize -- subtract mean, divide by stdev
    train_set = data_utils.normalize_data(
        train_set, data_mean, data_std, dim_to_use, actions, one_hot
    )
    test_set = data_utils.normalize_data(
        test_set, data_mean, data_std, dim_to_use, actions, one_hot
    )
