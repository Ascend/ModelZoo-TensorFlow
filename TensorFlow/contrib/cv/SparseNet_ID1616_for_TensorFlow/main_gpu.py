...
# os.system('pip3 uninstall tensorpack')
# os.system('y')

os.system('pip install --upgrade pip')
os.system('pip3 install --upgrade pip3')
os.system('pip install --upgrade pip3')
os.system('pip3 install opencv-python==3.4.9.31 -i http://mirrors.aliyun.com/pypi/simple --trusted-host mirrors.aliyun.com')
...
def get_data(train_or_test, args):
    ...
    if args.dataset == "c10":
        ...
        # dir = "/cache/dataset/cifar10_data"
...
if __name__ == '__main__':
    ...
    # temp_result_dir = "/cache/user-job-dir/train_log/"
