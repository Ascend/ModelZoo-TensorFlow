...
sys.path.append(os.path.join(BASE_DIR, 'utils1'))

import utils1.cpp_wrappers.cpp_subsampling.grid_subsampling as cpp_subsampling
import utils1.nearest_neighbors.lib.python.nearest_neighbors as nearest_neighbors
...
class ConfigS3DIS:
    ...
    train_sum_dir = '/cache/train_out/train_log'
    saving = True
    # saving_path = None
    saving_path = None
