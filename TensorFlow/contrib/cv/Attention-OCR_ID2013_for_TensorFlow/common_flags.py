...
def define():
  ...
  flags.DEFINE_string('dataset_dir', "/home/yuqiao/TF_model/research/attention_ocr/python/datasets/data/fsns",
                      'Dataset root folder.')
...
def create_dataset(split_name):
    ...
    return ds_module.my_get_split(split_name, dataset_dir=FLAGS.dataset_dir)

def create_eval_dataset(split_name):
    ds_module = getattr(datasets, FLAGS.dataset_name)
    return ds_module.get_split(split_name, dataset_dir=FLAGS.dataset_dir)
    # return ds_module.my_get_split(split_name, dataset_dir=FLAGS.dataset_dir)
