...
class ModelSkeleton:
    ...
    def __init__(self, mc, data_getnext):
        self.mc = mc
        self.keep_prob = mc.KEEP_PROB
        self.lidar_input = data_getnext[0]
        self.lidar_mask = data_getnext[1]
        self.label = data_getnext[2]
        self.loss_weight = data_getnext[3]
