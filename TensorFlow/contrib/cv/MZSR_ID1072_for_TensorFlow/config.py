...
parser.add_argument('--meta_iter', type=int, dest='meta_iter', default=2)
...
#npu
parser.add_argument('--result', type=str, dest='result', default='result')
parser.add_argument('--dataset', type=str, dest='dataset', default='dataset')


#ck2pb
parser.add_argument('--ck2pb', dest='is_ck2pb', default=False, action='store_true')
parser.add_argument('--usepb', dest='is_usepb', default=False, action='store_true')
parser.add_argument('--testom', dest='is_testom', default=False, action='store_true')

args= parser.parse_args()

#Transfer Learning From Pre-trained model.
IS_TRANSFER = True
TRANS_MODEL = args.dataset + '/Pretrained/Pretrained'
...
META_ITER=args.meta_iter#100000
META_BATCH_SIZE=5
META_LR=1e-4
