...
parser.add_argument('--print_interval', type=int, default=50, help='The number of steps between each validation')
parser.add_argument('--n_generator', type=int, default=50, help='Update ratio between discriminator and generator')
...
def train():
    ...
    for epo in range(args.max_epoch):  # The model is fine-tuned for another 2000 generator updates in the end.
        for npy, npy_path in enumerate(train_npy_paths):
            ...
            for step in range(1, int(batch_num) + 1-(int(batch_num)-2)):
                lr_img, hr_img, batch_id = get_next(batch_id, args.batch_size, sample_array, label_array)
                ...
                if global_steps % args.print_interval == 0:
                    ...
                    print('{} epo={},npy={},gen_loss={:.4f},dis_loss={:.5f},mse_loss={:.3f},step={},psnr={},time={}'.format(
                        current_time, epo, npy, generator_cost, discrim_cost, mse_cost, global_steps, psnr,duration))
