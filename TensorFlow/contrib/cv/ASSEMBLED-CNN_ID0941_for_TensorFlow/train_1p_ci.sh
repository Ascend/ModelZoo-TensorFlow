...
cd $cur_path/
sed -i "s|"./datasets"|"${data_path}"|g" train_testcase.sh
sed -i "s|"./pre_ckpt"|"${ckpt_path}"|g" train_testcase.sh
bash train_testcase.sh  | tee train_output.log

sed -i "s|"${data_path}"|"./datasets"|g" train_testcase.sh
sed -i "s|"${ckpt_path}"|"./pre_ckpt"|g" train_testcase.sh
