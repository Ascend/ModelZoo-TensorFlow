...
# parser.add_argument("--data_url", type=str, default="/celeba-mytest/celebA")
...
#solver
flags.DEFINE_string("train_dir", "./output", "trained model save path")
