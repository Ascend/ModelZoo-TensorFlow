...
def parser_():
    ...
    parser.add_argument('--log', default="./logs/", type=str,
                        help='log file')
    #parser.add_argument('--TRAIN_MAX_STEPS', default=650000, type=int, metavar='N', help='number of total steps to run')
    parser.add_argument('--TRAIN_MAX_STEPS', default=1100, type=int, metavar='N', help='number of total steps to run')
    ...
    parser.add_argument('--output_ckpt', default="test/", type=str, help='sgd or adam')
...
def train(train_loader, cfg):
    ...
    with tf.Session(config=config) as sess:
        ...
        for step in range(args.TRAIN_MAX_STEPS):
            ...
            print(
                "step : {}>>>>loss_val : {}， rpn_cls_loss : {}， rpn_loc_loss : {}，rpn_mask_loss : {}，cost_time : {}, TimeHistory : {}".format(
                    step,
                    loss_val,
                    rpn_cls_loss_val,
                    rpn_loc_loss_val,
            ...
            if step % 1000 == 0:
                saver.save(sess, os.path.join(log_path,
