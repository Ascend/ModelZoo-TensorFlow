...
#xport ASCEND_SLOG_PRINT_TO_STDOUT=1
...
cd $cur_path
#sed -i "s|"../datasets/celeba"|"${data_path}"|g" $cur_path/scripts/train_1p.sh
python3  no-local-net-tf_v100.py \
--data_url=$data_path \
--epoch=1 \
--batch_size=512 |tee  train_output.log 
