...
**描述（Description）：基于TensorFlow框架的图像迁移算法** 
...
- 适配昇腾 AI 处理器的实现：
    ...
    https://gitee.com/harry-zzh/modelzoo/edit/master/contrib/Tensorflow/MUNIT_ID0953_for_TensorFlow/
...
2.  参考脚本的模型存储路径为./test/output/${ASCEND_DEVICE_ID}/checkpoint/MUNIT_lsgan。
