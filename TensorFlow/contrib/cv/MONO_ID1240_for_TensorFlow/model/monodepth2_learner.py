...
class MonoDepth2Learner(object):
    ...
    def build_train(self):
        ...
        with tf.name_scope('data_loading'):
            tgt_image, src_image_stack, tgt_image_aug, src_image_stack_aug, intrinsics, ds_image_iterator, ds_cam_iterator = loader.load_batch()
        ...
        return ds_image_iterator, ds_cam_iterator
    ...
    def train(self, ckpt_dir):
        ds_image_iterator, ds_cam_iterator = self.build_train()
    ...
    def eval_depth(self, sess,ckpt_name):
        ...
        print(np.array(pred_all).shape, '--------------------------')    # (697, 192, 640)
