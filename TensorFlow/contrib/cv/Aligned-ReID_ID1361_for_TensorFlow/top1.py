...
tf.flags.DEFINE_integer('max_steps', '10', 'max steps for training')
tf.flags.DEFINE_string('logs_dir', 'D:/Desktop/Mindspore/AlignedReid/AlignedReID-master2/logs_paper_1x1_a_1x7/', 'path to logs directory')
tf.flags.DEFINE_string('data_dir', 'D:/Desktop/Mindspore/AlignedReid/AlignedReID-master2/data/', 'path to dataset')
...
def main(argv=None):
    ...
    with tf.Session(config=config) as sess:
        ...
        if FLAGS.mode == 'train':
            ...
            path = 'D:/Desktop/Mindspore/AlignedReid/AlignedReID-master2/data/'
            set = 'val'
