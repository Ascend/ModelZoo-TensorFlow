...
parser.add_argument('--data_dir', dest='data_dir', default='./datasets', help='data_dir for modelarts training')
parser.add_argument('--result', dest='result', default='./result', help='result dir for modelarts training')
...
def main(_):
    ...
    # config_proto = npu_tf_config.session_dump_config(config_proto, action='fusion_off')

    #custom_op.parameter_map["precision_mode"].s = tf.compat.as_bytes("allow_mix_precision")
    # custom_op.parameter_map["modify_mixlist"].s = tf.compat.as_bytes( "/home/work/user-job-dir/code/ops_info.json")
    with tf.Session(config=config_proto) as sess:
        model = DualNet(sess, image_size=args.image_size, batch_size=args.batch_size,\
                        ...
                        log_freq=args.log_freq, disc_type=args.disc_type, data_dir=args.data_dir,\
                        result=args.result)
