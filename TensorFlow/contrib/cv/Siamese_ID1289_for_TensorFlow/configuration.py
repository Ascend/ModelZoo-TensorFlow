...
WORKSPACE_DIR = './'
WORKSPACE = '/home/ysp/data/'
LOG_DIR = osp.join(WORKSPACE, 'Logs6/SA-Siam')  # where checkpoints, logs are saved
...
TRAIN_CONFIG = {
  ...
  'caffenet_dir': osp.join(caffenet_dir, 'caffenet.npy'),
  'output_dir': "/home/ysp/output/",
  'seed': 0,  # fix seed for reproducing experiments

  'train_data_config': {'input_imdb': osp.join(caffenet_dir, 'train_imdb.pickle'),
  ...
  'validation_data_config': {'input_imdb': osp.join(caffenet_dir , 'validation_imdb.pickle'),
