...
if [ x"${etp_flag}" != x ];
then
    python3.7 ./neural_style.py --content=${data_path}/1-content.jpg --styles=${data_path}/1-style.jpg --output=${output_path}/11.jpg --network=${data_path}/imagenet-vgg-verydeep-19.mat --iterations=${train_steps} --print-iterations 1 --progress-write --progress-plot &> ${print_log}
...
#train_accuracy=`grep "total loss:" ${print_log}  | tail -n 1`
