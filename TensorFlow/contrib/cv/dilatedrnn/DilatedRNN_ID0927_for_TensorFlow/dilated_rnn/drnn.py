...
# For better performance, we choose best cell -- basic rnn cell
def LSTMCell(hidden_dims):
    return tf.contrib.rnn.BasicRNNCell(hidden_dims)

def GRUCell(hidden_dims):
    return tf.contrib.rnn.BasicRNNCell(hidden_dims)