...
parser.add_argument('-savemodel', type=str, default='./checkpoints_npu/')
...
while step * batch_size < training_iters:
    ...
    if (step + 1) % display_step == 0:
        ...
        + ", Training Accuracy: " + "{:.6f}".format(accuracy_) + ", Training time: " + "{:.3f}".format(accuracy_))
...
if accuracy__ > best_val_perf:
    ...
    saver.save(sess, savemodel + cell_type + '/best_model.ckpt')