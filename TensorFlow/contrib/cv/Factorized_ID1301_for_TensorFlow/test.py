...
INPUT_DIR = 'Factorized-Spatial-Embeddings-master/datasets/celebA-test'  #读取数据集路径
OUTPUT_DIR = 'Factorized-Spatial-Embeddings-master/output' #输出图像路径
# OUTPUT_DIR = '/fse-test/output/test1/output/V0098/' #输出路径

# IMAGE_DIR=''
# checkpoint_dir=''

image_dir ='Factorized-Spatial-Embeddings-master/output'
...
CHECKPOINT = 'Factorized-Spatial-Embeddings-master/backup/model/V0101'
...
def get_arguments():
    ...
    """
    parser = argparse.ArgumentParser(description="Factorized Spatial Embeddings", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def save_images(fetches, args, step=None):     #存储输出的图像
    #image_dir = os.path.join(args.output_dir, "images")
    # image_dir = args.train_url
    print("---------输出图像位置", image_dir)
...
def main():
    ...
    with sv.managed_session() as sess:     #logdir中去找checkpoint，如果没有的话，自动执行初始化
