...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="VGG19_ID0374_for_TensorFlow"
#训练epoch
epochs=1
#训练batch_size
batch_size=256
...
python3 train.py \
	...
	--max_epochs=1 \
	--batch_size=256> ${cur_path}/test/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1
wait
...
#train_accuracy=`grep  -A1 "top1" $cur_path/test/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log|grep -v "top1"|awk '{print $3}'`
#打印，不需要修改
