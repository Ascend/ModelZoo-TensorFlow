...
import argparse
ckpt_path = "./scripts/vgg19ckpt/model.ckpt"

def parse_args():
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--ckpt_path', default="./scripts/vgg19ckpt/model.ckpt",help="""set checkpoint path""")
...
def main():
    ...
    with tf.Session() as sess:
        ...
        freeze_graph.freeze_graph(
		        ...
		        output_graph='./pb_model/vgg19_tf_910.pb',   #graph outputs name
		        clear_devices=False,
		        initializer_nodes='')
    print("done")
