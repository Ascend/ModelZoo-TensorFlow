...
class DataLoader:
    ...
    def __init__(self, args):
        ...
        print('total num_training_samples: %d' % self.num_training_samples) #1231025
        print('total num_evaluating_samples: %d' % self.num_evaluating_samples) #49921
...
def make_dataset(args, take_count, batch_size,
    ...
    if training:
        ...
        ds = ds.apply(tf.data.experimental.shuffle_and_repeat(shuffle_buffer_size, seed=5))
