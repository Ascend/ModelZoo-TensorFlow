...
parser.add_argument('--data_path', type=str, default='./data', help='train and val datasets')

parser.add_argument('--end_num_batches', type=int, default=0, help='contrl train batch')
parser.add_argument('--end_val_num_batches', type=int, default=0, help='contrl val batch')
...
def train_one_epoch(sess, ops, train_writer):
    ...
    for batch_idx in range(num_batches):
        ...
        if (batch_idx+1)%10 == 0:
            ...
            log_string('train mean loss: %f' % (loss_sum / 10))
...
def eval_one_epoch(sess, ops, test_writer):
    ...
    num_batches = (len(TEST_DATASET)+BATCH_SIZE-1)//BATCH_SIZE - FLAGS.end_val_num_batches
