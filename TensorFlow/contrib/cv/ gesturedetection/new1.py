...
if __name__ == '__main__':
    ...
    parser.add_argument("-datapath", "--datapath", type=str, default="/cache/dataset/data",
                        help="specific gpu id to use")
    # 增加train_url和data_url参数
    parser.add_argument("-data_url", "--data_url", type=str, default="./data",
                        help="specific gpu id to use")
    parser.add_argument("-train_url", "--train_url", type=str, default="./output",
                        help="specific gpu id to use")
    ...
    mox.file.copy_parallel(args.data_url, data_dir)#/cache/dataset/data
    ...
    mox.file.copy_parallel(outpath, args.train_url)

    # copy输出到obs
    #print(outpath)

    #mox.file.copy_parallel(outpath, config.train_url)
