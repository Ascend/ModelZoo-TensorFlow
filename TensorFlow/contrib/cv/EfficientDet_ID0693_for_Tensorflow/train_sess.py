...
def main(args=None):
    ...
    custom_op.parameter_map["profiling_options"].s = tf.compat.as_bytes('{"output":"/home/dingwei/efficientdet/profiling","storage-limit": "xxMB","training_trace":"on","l2":"on","task_trace":"on","aicpu":"on","fp_point":"resnet_model/conv2d/Conv2Dresnet_model/batch_normalization/FusedBatchNormV3_Reduce","bp_point":"gradients/AddN_70","aic_metrics":"PipeUtilization"}') 
    ...
    if args.snapshot:
        if args.snapshot == 'imagenet':
            ...
            model.load_weights('/home/dingwei/efficientdet/efficientnet-b0_weights_tf_dim_ordering_tf_kernels_autoaugment_notop.h5', by_name=True)
        else:
            print('Loading model, this may take a second...')
            model.load_weights(args.snapshot, by_name=True)
