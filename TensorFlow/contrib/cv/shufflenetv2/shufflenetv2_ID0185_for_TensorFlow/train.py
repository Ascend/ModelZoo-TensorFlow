...
NUM_STEPS = 1000
# 配置路径
TMP_TRAIN_DATA_Path = '/npu/traindata/NRE_shufflenetv2_tf_uestclzx/dataset/train' # 训练集
TMP_VAL_DATA_Path = '/npu/traindata/NRE_shufflenetv2_tf_uestclzx/dataset/val' # 测试集
PRETRAINED_MODE_PATH = '/npu/traindata/NRE_shufflenetv2_tf_uestclzx/model' # 预训练模型
TMP_MODEL_Path = './model_dir' # 训练生成模型
