...
# parameters
FLAGS = flags.FLAGS
flags.DEFINE_string('obs_dir', 'obs://hhy-obs/log','obs_dir')
...
flags.DEFINE_integer('val_freq', 500, 'How often to eval validation (# steps)')
...
flags.DEFINE_float('mutation_rate', 0.1, 'Mutation rate for data augmentation.')
flags.DEFINE_integer(
    'filter_label', -1,
    ('If only sequences from the class=filter_label are used for training.'
     'if -1, no filter.'))
#flags.DEFINE_string('in_tr_data_dir', r"/home/test_user04/dataset/before_2011_in_tr",
#                    'data directory of in-distribution training')
#flags.DEFINE_string('in_val_data_dir', r"/home/test_user04/dataset/between_2011-2016_in_val",
#                    'data directory of in-distribution validation')
#flags.DEFINE_string('ood_val_data_dir', r'/home/test_user04/dataset/between_2011-2016_ood_val',
#                    'data directory of OOD validation')
flags.DEFINE_string('in_tr_data_dir', r"llr_ood_genomics\before_2011_in_tr",
                    'data directory of in-distribution training')
flags.DEFINE_string('in_val_data_dir', r"llr_ood_genomics\between_2011-2016_in_val",
                    'data directory of in-distribution validation')
flags.DEFINE_string('ood_val_data_dir', r'llr_ood_genomics\between_2011-2016_ood_val',
                    'data directory of OOD validation')
flags.DEFINE_string('out_dir', 'work_dir/foreground',
                    'Directory where to write log and models.')
# flags.DEFINE_string('model_dir', 'work_dir/foreground',
#                     'Directory where to write log and models.')
...
class SeqModel(object):
  ...
  def reset(self):
    ...
    #    '{"output":"/cache/result/train_outbk","task_trace":"on"}')
  ...
  def print_log(self, str, print_time=True):
      ...
      with open("work_dir/ood.log", 'a') as f:
          print(str, file=f)
  ...
  def train(self, in_tr_dataset, in_val_dataset, ood_val_dataset, prev_steps):
    ...
    in_tr_dataset = in_tr_dataset.repeat().shuffle(1000).batch(
        self._params.batch_size, drop_remainder=True)
    ...
    for i in range(prev_steps, num_steps, 1):
      ...
      if i % self._params.val_freq == 0:
        ...
        self.print_log('i={} \t in_tr_loss={:.4f}, in_val_loss={:.4f}, ood_val_loss={:.4f}\n'
                       'in_tr_acc={:.4f}, in_val_acc={:.4f}, ood_val_acc={:.4f}\n'
  ...
  def pred_from_ckpt(self, test_dataset, num_samples):
    ...
    test_dataset = test_dataset.batch(self._params.batch_size, drop_remainder=True)
