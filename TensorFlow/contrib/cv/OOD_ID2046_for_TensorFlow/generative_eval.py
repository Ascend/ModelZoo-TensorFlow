...
flags.DEFINE_string(
    'model_dir_frgd',
    r'D:\workplace2\genomics_ood\rep_test\foreground',
    'Directory to ckpts of the foreground generative models.')
flags.DEFINE_string(
    'model_dir_bkgd',
    r'D:\workplace2\genomics_ood\rep_test\background',
...
flags.DEFINE_string(
    'in_test_data_dir',
    r'D:\workplace2\genomics_ood\llr_ood_genomics\after_2016_in_test',
    'Directory to in-distribution test data')
flags.DEFINE_string(
    'ood_test_data_dir',
    r'D:\workplace2\genomics_ood\llr_ood_genomics\after_2016_ood_test',
