...
from Train import resnet_v1, resnet_utils

from Train.resnet_v1 import bottleneck, bottleneck_skip
from Train.config import args, MEAN_COLOR
#from Train.paths import INIT_WEIGHTS_DIR

log = logging.getLogger()
slim = tf.contrib.slim
INIT_WEIGHTS_DIR = args.weights_path
