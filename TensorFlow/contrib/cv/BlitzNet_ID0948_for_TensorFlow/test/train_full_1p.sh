...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="BlitzNet_ID0948_for_TensorFlow"
#训练epoch
train_epochs=
#训练batch_size
batch_size=32
...
do
    ...
    python3 train_1p.py \
        --data_dir=${data_path}/Datasets \
        --weights_path=${data_path}/Weights_imagenet \
        --result_dir=./result \
        ...
        --lr_decay 25000 35000 > ${cur_path}test/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1
