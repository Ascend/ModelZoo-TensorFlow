...
class VarShapeLearner(object):
    def __init__(self,
        ...
        self.sess = tf.InteractiveSession(config=npu_config_proto())
    ...
    def _image_decoder(self, weights, biases):
        ...
        image_fclayer1 = npu_ops.dropout(image_fclayer1, keep_prob=self.keep_prob)
...
for epoch in range(total_epoch):
    ...
    for i in range(train_batch):
        ...
        if i % 50 == 0:
            print('train_batch Time : {}'.format(time.time()-start_time))
