...
flags.DEFINE_string("aug_dataset", "cifar10.1@250", "Name of dataset to perform augmentation on.")
...
# flags.DEFINE_string('data_url', 'obs://realmixdata/dataset', 'dataset directory.')
FLAGS = flags.FLAGS
...
def main(argv):
    ...
    for index, tfrecord in enumerate(tfrecords):
        ...
        # 将aug数据传输回来，可删除
        # mox.file.copy(filename,'obs://realmixdata/dataset')
        # print("tranport ok!")
