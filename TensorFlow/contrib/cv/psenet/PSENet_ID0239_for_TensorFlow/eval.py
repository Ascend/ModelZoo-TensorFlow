...
tf.app.flags.DEFINE_string('platform', 'NPU', 'platform of this eval.py to run, default is: npu')
...
def detect(seg_maps, timer, image_w, image_h, min_area_thresh=6, seg_map_thresh=0.9, ratio = 1):
    '''
            ...
            for im_fn in im_fn_list:
                ...
                if boxes is not None:
                    res_file = os.path.join(
                        FLAGS.output_dir,
                        '{}.txt'.format("res_"+os.path.splitext(
