...
flags.DEFINE_integer('save_summaries_secs', 30000000,
                     'number of seconds between saving summaries')
flags.DEFINE_integer('save_interval_secs', 30000000,
                     'numer of seconds between saving variables')
flags.DEFINE_integer('log_every_n_steps', 2000, 'number of steps between logging')
...
def test():
    ...
    with sv.managed_session(
            ...
            config=npu_config_proto(config_proto=tf.ConfigProto(allow_soft_placement=True))) as sess:
