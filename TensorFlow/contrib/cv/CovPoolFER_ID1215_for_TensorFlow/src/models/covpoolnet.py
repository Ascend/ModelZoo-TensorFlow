...
def inference(images, keep_probability, phase_train=True, bottleneck_layer_size=7, weight_decay=0.0, reuse=None,
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        return network(images, is_training=phase_train, dropout_keep_prob=keep_probability,
                       bottleneck_layer_size=bottleneck_layer_size, batch_size=batch_size)


def network(inputs, is_training=True, dropout_keep_prob=1, bottleneck_layer_size=7, reuse=None, scope='CovPoolNetwork',
            batch_size=128):
    # dropout_keep_prob=1
