...
class BUILD_NET_VGG16:
    def __init__(self, vgg16_npy_path=None):
        ...
        self.data_dict = np.load(vgg16_npy_path,allow_pickle=True, encoding='latin1').item() #Load weights of trained VGG16 for encoder
...
##-----------------------Build Net Fully connvolutional layers------------------------------------------------------------------------------------
        ...
        # 更改dropout部分
        self.relu_dropout6 = npu_ops.dropout(self.relu6,keep_prob=keep_prob)  # Apply dropout for traning need to be added only for training
        # self.relu_dropout6=npu_ops.dropout(self.relu6,keep_prob=keep_prob)
        ...
        # 更改dropout2
        self.relu_dropout7 = npu_ops.dropout(self.relu7, keep_prob=keep_prob)  # Another dropout need to be used only for training
        # self.relu_dropout7=npu_ops.dropout(self.relu7, keep_prob=keep_prob)
