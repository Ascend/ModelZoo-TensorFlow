...
#VGG_PATH = '/public/home/nanrh123/pyterm/fast-style-transfer-master/data/imagenet-vgg-verydeep-19.mat'
#TRAIN_PATH = '/public/home/nanrh123/pyterm/fast-style-transfer-master/data/train2014'
BATCH_SIZE = 4
#DEVICE = '/gpu:0'
FRAC_GPU = 1
...
def main():
    ...
    style_target = get_img(options.style)   #获取风格图
    if not options.slow:
    ...
    kwargs = {
        ...
        "print_iterations":options.checkpoint_iterations, #2000
