...
def main(args):
    ...
    ### Start running operations on the Graph.
        ...
        for epoch in range(args.check_point, args.max_nrof_epochs + 1):  # 1~40
            ...
            # mox.file.copy_parallel(model_dir, os.path.join('obs://ajian3/Jobs', 'models', subdir))
            # mox.file.copy_parallel(outputs_dir, os.path.join('obs://ajian3/Jobs', 'outputs', subdir))
            # mox.file.copy_parallel(scores_dir, os.path.join('obs://ajian3/Jobs', 'scores', subdir))
