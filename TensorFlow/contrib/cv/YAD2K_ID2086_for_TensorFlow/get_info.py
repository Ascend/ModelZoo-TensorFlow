...
model_body.load_weights(model_path)  # Load weight on the network
yolo_outputs = yolo_head(model_body.output, anchors, len(classes))  # Encode network output
...
total = 0
current = 0
valtxt = config1.dataset + "/2007_test.txt"
