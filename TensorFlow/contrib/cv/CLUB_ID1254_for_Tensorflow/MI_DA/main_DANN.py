...
parser.add_argument("--data_path", type=str, default="/home/TestUser05/CLUB/CLUB_NPU/code/dataset/", help="path to dataset folder")   #注意路径
parser.add_argument("--save_path", type=str, default="/home/TestUser05/CLUB/CLUB_NPU/code/savef/", help="path to save experiment output")  #注意路径
...
datasets = dataloader.load_datasets(data_path,{args.source:1,args.target:1})  #data_path变为data_dir
...
# 训练结束后，将ModelArts容器内的训练输出拷贝到OBS
# mox.file.copy_parallel(CONFIG.ROOT_DIR, args.train_url)  #浮点异常数据保存
