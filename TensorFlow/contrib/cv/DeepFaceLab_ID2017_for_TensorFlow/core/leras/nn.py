...
class nn():
    ...
    def initialize(device_config=None, floatx="float32", data_format="NHWC"):
        ...
        if nn.tf is None:
            ...
            #     tf.compat.as_bytes("/home/ma-user/modelarts/user-job-dir/code/DeepFaceLab/fusion_switch.cfg")
    ...
    @staticmethod
    def ask_choose_device_idxs(choose_only_one=False, allow_cpu=True, suggest_best_multi_gpu=False,
