...
if __name__ == '__main__':
    ...
    parser.add_argument('--end_step', type=int, default=0, help='contrl steps_per_epoch')
    parser.add_argument('--NUM_EPOCH', type=int, default=20, help='train epochs')
    parser.add_argument('--BATCH_SIZE', type=int, default=16, help='BATCH_SIZE')
    parser.add_argument('--save_ckpt', type=str, default='./save_ckpt', help='save ckpt')
    ...
    for ckpt in range(START, END + 1):
        ...
        net.fit_generator(datagen.flow(images, labels, batch_size=BATCH_SIZE),
                          steps_per_epoch=len(images) / BATCH_SIZE + 1 - args.end_step,
                            epochs=NUM_EPOCH)
