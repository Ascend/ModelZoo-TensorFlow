...
print('--train_path--',TMP_TRAIN_DATA_Path)
print('--val_path--',TMP_VAL_DATA_Path)
print('--pre_model--',PRETRAINED_MODE_PATH)
print('--save_model_path--',TMP_MODEL_Path)
...
run_config = NPURunConfig(
    ...
    save_checkpoints_steps = 427040,  #32个epoch保存一次模型,（1281144 // 96） * 32
