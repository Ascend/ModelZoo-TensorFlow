...
You can use any datasets as you wish. Here, we only use DIV2K dataset as an example to illustrate the data generation.

the preprocess of datasets, pls according to GPU refenrence: https://github.com/hiram64/ESRGAN-tensorflow.git
