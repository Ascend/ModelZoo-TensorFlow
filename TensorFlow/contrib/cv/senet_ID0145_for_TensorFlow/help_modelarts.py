...
def modelarts_result2obs(FLAGS):
    ...
    mox.file.copy_parallel(src_url=FLAGS.log_dir, dst_url=obs_result_dir)
    print("===>>>Copy Event or Checkpoint from modelarts dir:{} to obs:{}".format(FLAGS.log_dir, obs_result_dir))
