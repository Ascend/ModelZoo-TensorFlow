...
class Dataset(object):
    ...
    test_on_trainset_path = osp.join('/home/zwx1046924', 'data', dataset_name, 'input_pose', 'test_on_trainset', 'result.json')
    input_pose_path = osp.join('/home/zwx1046924', 'data', dataset_name, 'input_pose', 'person_keypoints_256x192_resnet50_val2017_results.json') # set directory of the input pose

    img_path = osp.join('/home/zwx1046924', 'data', dataset_name, 'images')
    train_annot_path = osp.join('/home/zwx1046924', 'data', dataset_name, 'annotations', 'person_keypoints_train2017.json')
    val_annot_path = osp.join('/home/zwx1046924', 'data', dataset_name, 'annotations', 'person_keypoints_val2017.json')
    test_annot_path = osp.join('/home/zwx1046924', 'data', dataset_name, 'annotations', 'image_info_test-dev2017.json')
