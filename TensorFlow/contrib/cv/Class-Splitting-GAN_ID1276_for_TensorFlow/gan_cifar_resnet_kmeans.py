...
softmax = None
MODEL_DIR = '/home/TestUser03/splitting_gan-master/dataset/imagenet'
#DATA_URL = 'http://download.tensorflow.org/models/image/imagenet/inception-2015-12-05.tgz'
DATA_DIR_cifar10 = '/home/TestUser03/splitting_gan-master/dataset/cifar-10-batches-py'
...
class splitting_cifar:
    ...
    def recalc_labels(self, session, formula, iteration):
        ...
        lib.save_images.save_images(all_samples.reshape((self.n_classes*10, 3, 32, 32)), './result/samples/cluster_samples_%d.png'%iteration, mod=10)
...
#with tf.Session() as session:
    ...
    def generate_image_b(frame, n_per_class):
        ...
        lib.save_images.save_images(all_samples.reshape((data_provider.n_classes*n_per_class, 3, 32, 32)), './result/samples/random_samples_{}.png'.format(frame))
