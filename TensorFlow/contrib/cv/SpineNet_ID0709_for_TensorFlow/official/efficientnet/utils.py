...
def build_optimizer(learning_rate,
  ...
  if optimizer_name == 'sgd':
    ...
    optimizer = npu_tf_optimizer(tf.train.GradientDescentOptimizer(learning_rate=learning_rate))
    ...
    optimizer = npu_tf_optimizer(tf.train.RMSPropOptimizer(learning_rate, decay, momentum,
                                          epsilon))
