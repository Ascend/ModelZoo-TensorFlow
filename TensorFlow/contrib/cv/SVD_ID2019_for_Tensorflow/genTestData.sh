...
inputDataPath="points_test/*.pts"
TestdataPath="test_points_modified"

Data_Path="$data_path$inputDataPath"
outputPath="$output_path$TestdataPath"
AXANG_SAMPLIE="True"
...
then
    python  /home/ma-user/modelarts/user-job-dir/code/gen_pt_test_data.py\
                            --input_test_files=${Data_Path} \
                            --output_directory=${outputPath} \
                            --random_rotation_axang=${AXANG_SAMPLIE}
else
    python  /home/ma-user/modelarts/user-job-dir/code/gen_pt_test_data.py\
                            --input_test_files=${Data_Path} \
                            --output_directory=${outputPath} \
