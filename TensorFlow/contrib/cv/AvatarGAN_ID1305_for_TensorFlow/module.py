...
def discriminator(image, options, reuse=False, name="discriminator"):
    '''
    realization of the discriminator
    :param image: input
    :param options:
    :param reuse:
    :param name:
...
def generator_unet(image, options, reuse=False, name="generator"):
    '''
    using unet to realize the generator
    :param image: input
    :param options:
    :param reuse: is reuseable
    :param name: variable scope
    :return: generated tensor result
    '''
...
def generator_resnet(image, options, reuse=False, name="generator"):
    '''
    using res-net to realize the generator
    :param image:
    :param options:
    :param reuse:
    :param name:
...
def mae_criterion(in_, target):
    '''
    calculate mean value of all element.
    :param in_:
    :param target:
    :return:
    '''
...
def sce_criterion(logits, labels):
    '''
    calculate cross entropy loss with sigmoid
    :param logits:
    :param labels:
    :return:
    '''
