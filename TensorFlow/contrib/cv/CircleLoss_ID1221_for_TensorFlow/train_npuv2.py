...
arg.add_argument('-b','--batch_size',type=int,default=96)
...
arg.add_argument("--data_dir", type=str, default="/cache/dataset/")
...
# 预训练模型
ckptpath = os.path.join(data_dir,args.ckptpname)
...
model_save_path = ckpt_output_dir + args.expriment_name
