...
bool Utils::is_path_exist(const std::string &path) {
...
void Utils::split_path(const std::string &path, std::vector<std::string> &path_vec) {
...
void Utils::get_all_files(const std::string &path, std::vector<std::string> &file_vec) {
    // split file path
...
void Utils::get_path_files(const std::string &path, std::vector<std::string> &file_vec) {
