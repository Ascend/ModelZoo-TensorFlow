...
class SVHN(object):
    def __init__(self, flags, dataset_name):
        ...
        self.svhn_train_path = os.path.join(FLAGS.svhn_path, self.dataset_name,'train_32x32.mat')
        self.svhn_val_path = os.path.join(FLAGS.svhn_path, self.dataset_name, 'test_32x32.mat')
        self._load_svhn()
