...
tf.flags.DEFINE_string('data_path', './MNIST-data', 'data path')
...
def mnist(layers,  # pylint: disable=invalid-name
  ...
  # Data.
  data = mnist_dataset.load_mnist(train_dir=FLAGS.data_path)
  #data=input_data.read_data_sets('/home/ma-user/modelarts/user-job-dir/code/MNIST-data/', one_hot=True)
