...
# os.system("pip install scipy==1.5.1")
# print("-----------------------------------------")
# os.system("pip install matplotlib==2.2.4")
# print("-----------------------------------------")
os.system("pip install pypng==0.0.19")
print("-----------------------------------------")
os.system("pip install Cython==0.29.10")
print("-----------------------------------------")
os.system("pip install PyOpenGL==3.1.0")
print("-----------------------------------------")
os.system("pip install triangle==20190115.2")
print("-----------------------------------------")
os.system("pip install glumpy==1.1.0")
print("-----------------------------------------")
os.system("pip install opencv-python")
print("-----------------------------------------")
os.system("pip install Pillow==8.2.0")
print("-----------------------------------------")
os.system("pip install vispy==0.6.5")
print("-----------------------------------------")
...
p = {
  ...
  'result_filenames': [
    'pix2pose-iccv19_tless-test-primesense.csv',
  ],

  # Folder with results to be evaluated.
  'results_path': '/home/ma-user/modelarts/inputs/data_url_0/tless/',

  # Folder for the calculated pose errors and performance scores.
  'eval_path': '/home/ma-user/modelarts/outputs/train_url_0/',
...
parser.add_argument("--code_path", type=str, default="/home/ma-user/modelarts/user-job-dir/src/tools/")
parser.add_argument('--renderer_type', default=p['renderer_type'])
parser.add_argument('--result_filenames',
                    default=','.join(p['result_filenames']),
                    help='Comma-separated names of files with results.')
#parser.add_argument('--results_path', default=p['results_path'])
parser.add_argument('--output_path', default="/home/ma-user/modelarts/outputs/train_url_0/")
parser.add_argument('--targets_filename', default=p['targets_filename'])
config = parser.parse_args()


config_datasets_path=config.data_path+"tless/"
config_results_path=config.data_path+"tless/"

config_eval_path=config.data_path

sys.path.append(config.code_path)
code_path=config.code_path
p['renderer_type'] = str(config.renderer_type)
p['result_filenames'] = config.result_filenames.split(',')
p['results_path'] = str(config_results_path)
p['eval_path'] = str(config_eval_path)
p['targets_filename'] = str(config.targets_filename)
print('debug3')
