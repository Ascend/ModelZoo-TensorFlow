...
import os,sys
sys.path.append(".")
sys.path.append("./src/bop_toolkit") #add
...
#使用models_cad      train=True， eval_model=False
#使用models_reconst  train=False，eval_model=False
#使用models_eval     train=True/False， eval_model=True
