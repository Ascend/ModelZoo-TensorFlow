...
def parse_args():
    ...
    parser.add_argument('--pbdir', type=str, default=r'mdoel/pb', help='pb files output path.')
    ...
    parser.add_argument('--pb-name', type=str, default=r'test_mri.pb', help='pd file name.')
...
def main():
    ...
    with tf.Session() as sess:
        ...
        inputs = tf.placeholder(tf.float32, shape=[None, 255, 255], name=args.input_node_name)

        logits = autoencoder(inputs)
