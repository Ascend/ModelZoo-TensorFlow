...
def random_split_trans2h5(in_file_path, output_path, criteo_stats, part_rows=2000000, train_size=TRAIN_LINE_COUNT, test_ratio=0.1, seed=2020):
    test_size = int(train_size * test_ratio)
    train_size = train_size - test_size
    all_indices = [i for i in range(train_size)]
    np.random.seed(seed)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_path', default="./data/", help='The path to save dataset')
    parser.add_argument('--output_h5_path', default="./data/", help='The path to save dataset')
    parser.add_argument('--output_tfrecord_path', default="./data//", help='The path to save dataset')
    parser.add_argument('--file', default='train.txt', help='Data file name')
    parser.add_argument('--test_ratio', default=0.1, type=float, help='Lines of train data')
    parser.add_argument('--num_lines', default=TRAIN_LINE_COUNT, type=int, help='Lines of train data')
    ...
    data_file_path = args.base_path + args.file
    stats_output_path = args.base_path + "stats_dict/"
    ...
    train_part_number,test_part_number = random_split_trans2h5(in_file_path, args.output_h5_path, criteo_stats, part_rows=2000000, train_size=args.num_lines, test_ratio=args.test_ratio, seed=2020)
