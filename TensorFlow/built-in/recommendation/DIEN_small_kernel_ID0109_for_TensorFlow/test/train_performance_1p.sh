...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="DIEN_small_kernel_ID0109_for_TensorFlow"
#训练epoch
train_epochs=500
#训练batch_size
batch_size=128
...
##获取错误信息
#系统错误信息
#error_msg="gradients/MatMul_88_grad/MatMul_1"
...
#ModelStatus="图执行FAIL"
#DTS单号或者issue链接
#DTS_Number="TuscanyV1R1C81_IR_0290_SF_040_SR_001_AR_002,TuscanyV1R1C81_IR_0290_SF_040_SR_001"
