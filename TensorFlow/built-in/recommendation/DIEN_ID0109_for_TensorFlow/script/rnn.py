...
def bidirectional_dynamic_rnn(cell_fw, cell_bw, inputs, sequence_length=None,
  ...
  assert_like_rnncell("cell_fw must be an instance of RNNCell", cell_fw)
  assert_like_rnncell("cell_bw must be an instance of RNNCell", cell_bw)
...
def dynamic_rnn(cell, inputs, att_scores=None, sequence_length=None, initial_state=None,
  ...
  """
  assert_like_rnncell("cell must be an instance of RNNCell", cell)
