...
def parse_args():
    ...
    parser.add_argument("--data_path", default="/npu/traindata/tf_record",
...
if __name__ == '__main__':
    ...
    args = parse_args()
    if args.data_path == "/npu/traindata/tf_record":
        pass
    else:
        ...
        for line in lines:
            f2.write(line.replace('record_path = \'/npu/traindata/tf_record\'', 'record_path = \'' + args.data_path + '\''))
        f2.close()
        f1.close()
