...
def DCNMixEstimator(linear_feature_columns, dnn_feature_columns, cross_num=2, dnn_hidden_units=(256, 128, 64),
                 l2_reg_linear=1e-5,
    ...
    return NPUEstimator(_model_fn, model_dir=model_dir, config=config)
