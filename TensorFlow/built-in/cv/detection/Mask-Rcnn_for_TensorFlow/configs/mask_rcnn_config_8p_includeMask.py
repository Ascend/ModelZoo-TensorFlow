...
MASK_RCNN_CFG = {
    ...
    'resize_method': 'faster_rcnn', #'retinanet',  # or 'faster_rcnn'
    'image_size': [1024, 1024],
    'short_side': 800,
    'long_side': 1333,
    'input_rand_hflip': True,
    'aug_scale_min': 0.8, #1.0,
    'aug_scale_max': 1.25, #1.0,
    'gt_mask_size': 112,
    ...
    'total_steps': 90000, #22500,
    'training_file_pattern': '../../data_reMake_includeMask/train*',
    # ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
    # 'resnet200'] for resnet backbone.
    # ['mnasnet-a1', 'mnasnet-b1', 'mnasnet-small'] for mnasnet backbone.
    'backbone': 'resnet50',
    'checkpoint': '../../npu_pretrain/resnet-50-imagenet/model.ckpt',
    ...
    'eval_samples': 5000,
    'validation_file_pattern': '../../data_reMake_includeMask/val*',
    'val_json_file': '../../data_reMake_includeMask/instances_val2017.json',
