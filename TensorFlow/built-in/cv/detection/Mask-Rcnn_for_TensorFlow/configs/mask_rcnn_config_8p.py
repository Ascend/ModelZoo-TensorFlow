...
MASK_RCNN_CFG = {
    ...
    'total_steps': 100, #22500,
    'training_file_pattern': '/autotest/shaobin/npu_data/coco_official_2017/tfrecord/train2017*',
    # ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
    # 'resnet200'] for resnet backbone.
    # ['mnasnet-a1', 'mnasnet-b1', 'mnasnet-small'] for mnasnet backbone.
    'backbone': 'resnet50',
    'checkpoint': '/autotest/shaobin/npu_pretrain/resnet-50-imagenet/model.ckpt',
    ...
    # ---------- Eval configurations ----------
    'eval_batch_size': 1,
    'num_steps_per_eval': 1000000,
    'eval_samples': 5000,
    'validation_file_pattern': '/autotest/shaobin/npu_data/coco_official_2017/tfrecord/val2017*',
    'val_json_file': '/autotest/shaobin/npu_data/coco_official_2017/annotations/instances_val2017.json',
