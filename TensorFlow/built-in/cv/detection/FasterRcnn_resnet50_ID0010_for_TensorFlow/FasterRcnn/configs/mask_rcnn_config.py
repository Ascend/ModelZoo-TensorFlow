...
MASK_RCNN_CFG = {
    ...
    'aug_scale_min': 0.8,
    'aug_scale_max': 1.25,
    'copy_paste_aug_scale_min': 0.1,
    'copy_paste_aug_scale_max': 2.0,
    'gt_mask_size': 112,
    # dataset specific parameters
    'num_classes': 91,
    'skip_crowd_during_training': True,
    'use_category': True,
    'copy_paste_aug': True, ## Data Enhance
    ...
    'l2_weight_decay': 5.0e-5,
    # ---------- Training configurations ----------
    'train_batch_size': 2,
    'learning_rate_type': 'cosine',  # 'step' or 'cosine'.
    ...
    'total_steps': 90000,
    'training_file_pattern': '/npu/traindata/coco_official_2017/tfrecord/train2017*',
    # ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
    # 'resnet200'] for resnet backbone.
    # ['mnasnet-a1', 'mnasnet-b1', 'mnasnet-small'] for mnasnet backbone.
    'backbone': 'resnet50',
    'checkpoint': '/npu/traindata/resnet50_ckpt',
    ...
    # NPU
    # not used for now
    'npu_loss_scale_flag': 0,
    # 0: dynamic loss-scale, >=1: fixed loss-scale
    'npu_loss_scale': 0,
    # ['allow_fp32_to_fp16', 'force_fp16', 'must_keep_origin_dtype', 'allow_mix_precision']
    'npu_precision_mode': 'allow_mix_precision',
    'npu_overflow_dump': False,
    ...
    # ---------- Eval configurations ----------
    'eval_batch_size': 16,
    'num_steps_per_eval': 90000,
    'eval_samples': 5000,
    'validation_file_pattern': '/npu/traindata/coco_official_2017/tfrecord/val2017*',
    'val_json_file': '/npu/traindata/coco_official_2017/annotations/instances_val2017.json',
