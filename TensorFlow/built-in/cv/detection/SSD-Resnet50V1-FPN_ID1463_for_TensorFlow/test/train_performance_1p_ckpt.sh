...
pipeline_config=$cur_path/../models/research/configs/ssd320_full_1gpus_ckpt.config
...
DTS_Number="DTS202105200RLRJ1P1300"echo "ModelStatus = ${ModelStatus}" >> $cur_path/output/$ASCEND_DEVICE_ID/${CaseName}.log
