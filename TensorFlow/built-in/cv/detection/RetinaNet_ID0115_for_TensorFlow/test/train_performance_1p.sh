...
sed -i  's#\("device_id":"\).*#\1'"$ASCEND_DEVICE_ID"'",#g' ${cur_path}/../npu_configs/rank_table_1p.json

#集合通信参数,不需要修改
export RANK_SIZE=1
export RANK_TABLE_FILE=${cur_path}/../npu_configs/rank_table_1p.json
export JOB_ID=10087
RANK_ID_START=0
...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="RetinaNet_ID0115_for_TensorFlow"
#训练epoch
train_epochs=0
#训练batch_size
batch_size=2
