...
**描述（Description）：基于TensorFlow框架的AlignedReID行人重识别训练代码**

<h2 id="概述.md">概述</h2>

-    AlignedReID是旷视于2017年发表的行人重识别网络。该网络利用动态规划求最小路径进行特征对齐，使用基于局部特征学习得到的全局特征能够有效提升识别准确率。
...
- 参考实现：
    ...
    [https://github.com/Phoebe-star/AlignedReID](https://github.com/Phoebe-star/AlignedReID)
...
-   网络结构
    ...
    - 初始学习率为0.01，使用exponential_decay
...
```
      数据集应有如下结构,预训练模型也应置于该目录下，配置data_path时需指定为cuhk03这一层，例：--data_path=/home/cuhk03
      ├─cuhk03
          ├─data
          |  ├─detected
          |  |    ├─train
