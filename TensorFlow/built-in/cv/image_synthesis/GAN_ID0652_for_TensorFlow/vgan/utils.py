...
def session(graph=None, allow_soft_placement=True,
    ...
    config = npu_config_proto(config_proto=tf.ConfigProto(allow_soft_placement=allow_soft_placement,
                            log_device_placement=log_device_placement))
    config.gpu_options.allow_growth = allow_growth
    return tf.Session(config=npu_config_proto(config_proto=config), graph=graph)
