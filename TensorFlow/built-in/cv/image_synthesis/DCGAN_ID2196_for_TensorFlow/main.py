...
def main(_):
  ...
  # custom_op.parameter_map["dump_path"].s = tf.compat.as_bytes("./overdump")
  # # enable_dump_debug：是否开启溢出检测功能
  # custom_op.parameter_map["enable_dump_debug"].b = True
  # # dump_debug_mode：溢出检测模式，取值：all/aicore_overflow/atomic_overflow
  # custom_op.parameter_map["dump_debug_mode"].s = tf.compat.as_bytes("all")
  run_config.graph_options.rewrite_options.remapping = RewriterConfig.OFF
  run_config.graph_options.rewrite_options.memory_optimization = RewriterConfig.OFF


  with tf.Session(config=npu_config_proto(config_proto=run_config)) as sess:#add_npu_custom_op
