...
def npu_loss_scale_optimizer(opt, loss_scale, is_distributed=False):
    """A wrap function of loss scaling optimizer for NPU tensorflow.
    ...
    Args:
        ...
        loss_scale: str, specifying the strategy to apply loss scaling. 
            ...
            scale factor, `2^(int(*))`.
        is_distributed: boolean, whether in distributed training.
    
    Returns:
        a wrapped optimizer with loss scaling.
    """
