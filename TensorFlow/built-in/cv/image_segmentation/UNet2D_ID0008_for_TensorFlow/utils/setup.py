...
def build_estimator(params, model_dir):
    ...
    config.gpu_options.visible_device_list = str(int(os.getenv("RANK_ID")))
    # for npu
    #dump_config = DumpConfig(enable_dump_debug = True, dump_path = "/npu/jwx644041/output", dump_debug_mode = "all" )
