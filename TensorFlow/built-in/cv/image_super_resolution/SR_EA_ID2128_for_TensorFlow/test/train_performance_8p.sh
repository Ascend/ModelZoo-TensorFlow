...
nohup vega ${cur_path}/configs/sr_ea_8p_perf.yml -b t -d NPU > \
...
grep -r "INFO Saving dict for global step" $cur_path/test/output/$npu_id/train_$npu_id.log | awk '{print $18}' > $cur_path/output/$npu_id/train_${CaseName}_loss.txt
