...
do
    ...
    nohup python3 -u main.py --train_GT_path ${data_path}/DIV2K_train_HR --train_LR_path ${data_path}/DIV2K_train_LR_bicubic/X2 --max_step 12 --scale 2 --log_freq 1 > ${cur_path}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
if [ $? -ne 0 ];then
  exit 1
fi
done
