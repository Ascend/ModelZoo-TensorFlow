...
def main():
    ...
    if FLAGS.data_path == "/npu/traindata/imagenet_TF":
        print("1111111")
        pass
    else:
        print("iiiiiiiiiiiiiiiii")
        f1 = open("../configs/" + cfg_file + ".py", "r")
        lines = f1.readlines()
        f2 = open("../configs/" + cfg_file + ".py", "w")
        print("fffffffffffff")
        for line in lines:
            f2.write(line.replace('\'data_url\': \'file:///npu/traindata/imagenet_TF\',', '\'data_url\': \'file://' + FLAGS.data_path + '\','))
