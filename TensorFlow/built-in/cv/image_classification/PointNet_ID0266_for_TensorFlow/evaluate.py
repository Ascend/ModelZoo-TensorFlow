...
SHAPE_NAMES = [line.rstrip() for line in \
    open(os.path.join(BASS_DIR, 'modelnet40_ply_hdf5_2048/shape_names.txt'))] 

HOSTNAME = socket.gethostname()
#rewrite the address as the original getDataFiles is not flexible in ETP
TRAIN_FILES = provider.getDataFiles(os.path.join(BASS_DIR, 'modelnet40_ply_hdf5_2048/train_files.txt'))
# ModelNet40 official train/test split
#rewrite the address as the original getDataFiles is not flexible in ETP
#build a new getDatatestFiles in provide.py
        ...
        for batch_idx in range(num_batches):
            ...
            for i in range(start_idx, end_idx):
                ...
                if pred_val[i-start_idx] != l and FLAGS.visu: # ERROR CASE, DUMP!
                    ...
                    #just dont utlize imsave, useless opeartion
                    error_cnt += 1
