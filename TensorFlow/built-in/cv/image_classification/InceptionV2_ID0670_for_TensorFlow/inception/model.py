...
class Model(object):
    ...
    def get_estimator_model_func(self, features, labels, mode):
        ...
        if is_training:
            with slim.arg_scope(inception_v2.inception_v2_arg_scope(weight_decay=self.args.weight_decay)):
                top_layer, end_points = inception_v2.inception_v2(inputs=features,
        ...
        train_op = tf.group(train_op,update_ops,name="IterationOp")
