...
def init_npu():
  ...
  if flags.FLAGS.over_dump == "True":
      print("NPU overflow dump is enabled")
      custom_op.parameter_map["dump_path"].s = tf.compat.as_bytes(flags.FLAGS.over_dump_path)
...
def define_resnet_flags(resnet_size_choices=None, dynamic_loss_scale=False,
  ...
  # enable overflow
  flags.DEFINE_string(
      name='over_dump', default="False",
      help=flags_core.help_wrap(
          'whether to enable overflow.'))
  flags.DEFINE_string(
      name='over_dump_path', default="./",
      help=flags_core.help_wrap(
