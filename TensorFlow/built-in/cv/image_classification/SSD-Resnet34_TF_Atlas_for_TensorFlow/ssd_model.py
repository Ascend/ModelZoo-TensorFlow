...
def concat_outputs(cls_outputs, box_outputs):
  ...
  for i, k in enumerate(keys):
    ...
    # reshape is correct.
    scale = ssd_constants.FEATURE_SIZES[i] # 涓嶅悓鐗瑰緛灏哄害, 38,19,10,5,3,1
    split_shape = (ssd_constants.NUM_DEFAULTS[i], ssd_constants.NUM_CLASSES) # 锛4,81锛夈侊紙6,81锛...
    ...
    intermediate_shape = (batch_size, scale, scale) + split_shape # (32, 19,19) + (6,4) 涓洪伩鍏嶆涔夛紝浠ョ浜屼釜default box涓轰緥
