...
**描述（Description）：基于TensorFlow框架的desnet3d网络训练代码**

<h2 id="概述.md">概述</h2>

## 简述

该存储库包含论文“Hierarchical MRI tumor segmentation with densely connected 3D CNN”中描述的原始模型，包括dense24、dense48和no-dense

- 参考论文

  https://arxiv.org/abs/1802.02427

- 参考实现

  https://github.com/lelechen63/MRI-tumor-segmentation-Brats
...
1. 训练模型使用BTRAS2017数据集，用户自行准备好数据集
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2. 1单卡训练指令（脚本位于 Densenet_3D_for_TensorFlow/test/train_full_1p.sh）
        
            bash test/train_full_1p.sh --data_path=BTRAS2017
