...
def _set_image_shape(shape):
    ...
    score_map_shape = (int(h / strides[0]), int(w / strides[0]))     #edit 2022/7/14
...
def init_config(image_shape, batch_size = 1, 
    ...
    batch_size_per_gpu = int(batch_size_per_gpu) ### edit in 2022/7/13
...
def load_config(path):
    ...
    if util.io.exists(config_file):
        ...
        util.io.copy('./config.py', path)       #ModelArts特供         @@@@@@@@@@@@@@@@@@@@@@@@@@