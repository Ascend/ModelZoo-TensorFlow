...
if __name__=='__main__':
    ...
    para = ['–g=gt.zip', '–s=txt.zip', '–o=./', '-p={\"IOU_CONSTRAINT\":0.5}']
    rrc_evaluation_funcs.main_evaluation(None, default_evaluation_params, validate_data, evaluate_method, para=para)
