...
do
    ...
    python3 infer_from_pb.py \
        --model_path=${ckpt_path}/dataset/resnet50_910.pb \
...
#train_accuracy=`grep "Top1 accuracy" $cur_path/output/$ASCEND_DEVICE_ID/train_$ASCEND_DEVICE_ID.log|awk '{print $3}'`
train_accuracy="NULL"
...
##获取性能数据，不需要修改
#吞吐量
step_sec=`grep "images/sec"  $cur_path/output/$ASCEND_DEVICE_ID/train_$ASCEND_DEVICE_ID.log|awk 'END {print $3}'`
ActualFPS=${step_sec}
#单迭代训练时长
TrainingTime="NULL"
