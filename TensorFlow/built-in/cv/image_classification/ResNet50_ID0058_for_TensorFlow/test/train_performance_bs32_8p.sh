...
#修改参数
sed -i "50s|PATH_TO_BE_CONFIGURED|${data_path}|g"  $cur_path/../src/configs/res50_32bs_8p.py
sed -i "107s|PATH_TO_BE_CONFIGURED|${cur_path}/output/0/d\_solution/ckpt0|g"  $cur_path/../src/configs/res50_32bs_8p.py
...
do
    ...
    nohup ${bind_core} python3.7 ${cur_path}/../src/mains/res50.py --config_file=res50_32bs_8p \
...
#参数改回
sed -i "50s|${data_path}|PATH_TO_BE_CONFIGURED|g"  $cur_path/../src/configs/res50_32bs_8p.py
sed -i "107s|${cur_path}/output/0/d\_solution/ckpt0|PATH_TO_BE_CONFIGURED|g"  $cur_path/../src/configs/res50_32bs_8p.py
