...
sed -i "112s|./src/trainers/ReduceMeanD.jsonn|${cur_path}/../ReduceMeanD.json|g" $cur_path/../src/trainers/gpu_base_trainer.py
...
do
    ...
    nohup python3.7 ${cur_path}/../src/mains/res50.py --config_file=res50_32bs_1p \
