...
- 单卡训练 
  ...
  2. 启动训练。
     ...
     启动单卡性能训练 （脚本为ResNet34_for_TensorFlow/test/train_performance_1p.sh） 

     ```
     bash train_performance_1p.sh
     ```
     
     启动单卡精度训练 （脚本为ResNet34_for_TensorFlow/test/train_full_1p.sh） 
...
- 8卡训练
  ...
  2. 启动训练。
     ...
     启动8卡性能训练 （脚本为ResNet34_for_TensorFlow/test/train_performance_8p.sh） 

     ```
     bash train_performance_8p.sh
     ```
		
     启动8卡精度训练 （脚本为ResNet34_for_TensorFlow/test/train_full_8p.sh） 
