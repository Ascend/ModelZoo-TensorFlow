...
#修改参数
#sed -i "s|'num_epochs': 120|'num_epochs': 10|g" $cur_path/../code/resnext50_train/configs/res50_256bs_8p_host.py
sed -i "s|file:///data/imagenet_TF|file://$data_path|g"  $cur_path/../code/resnext50_train/configs/res50_256bs_8p_host.py
sed -i "s|ckpt_dir': '/home/models/training_shop/03-code/ModelZoo_ResNext50_TF_MTI/d_solution/ckpt0|ckpt_dir': '${cur_path}/output/7/ckpt|g"  $cur_path/../code/resnext50_train/configs/res50_256bs_8p_host.py
wait
...
#参数改回
#sed -i "s|'num_epochs': 10|'num_epochs': 120|g" $cur_path/../code/resnext50_train/configs/res50_256bs_8p_host.py
sed -i "s|file://$data_path|file:///data/imagenet_TF|g"  $cur_path/../code/resnext50_train/configs/res50_256bs_8p_host.py
sed -i "s|ckpt_dir': '${cur_path}/output/7/ckpt|ckpt_dir': '/home/models/training_shop/03-code/ModelZoo_ResNext50_TF_MTI/d_solution/ckpt0|g"  $cur_path/../code/resnext50_train/configs/res50_256bs_8p_host.py
wait
...
train_accuracy=`tail -n2 $cur_path/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log|head -1|awk '{print $3}'`
