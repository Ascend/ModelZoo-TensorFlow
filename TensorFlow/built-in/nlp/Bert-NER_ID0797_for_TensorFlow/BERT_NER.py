...
# "True"
# if we used in bio-medical field锛宒on't do lower case would be better!
...
# flags.DEFINE_integer("npu_bert_loss_scale", -1, "Whether to use loss scale, -1 is disable, 0 is dynamic loss scale, >=1 is statis loss scale")
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        #estimator.train(input_fn=train_input_fn, max_steps=num_train_steps,
                        #hooks=npu_hooks_append(hooks_list=training_hooks))
