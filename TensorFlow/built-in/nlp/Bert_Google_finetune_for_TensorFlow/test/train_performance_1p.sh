...
#基础参数，需要模型审视修改
#网络名称，同目录名称
Network="Bert_Google_finetune_for_TensorFlow"
#训练batch_size
train_batch_size=32
#训练ephch
...
nohup python3  run_classifier.py \
       ...
       --output_dir=${cur_path}/${output_dir} > $cur_path/output/$ASCEND_DEVICE_ID/train_$ASCEND_DEVICE_ID.log 2>&1 &
...
CaseName=${Network}_${model}_bs${BatchSize}_${RankSize}'p'_'perf'
