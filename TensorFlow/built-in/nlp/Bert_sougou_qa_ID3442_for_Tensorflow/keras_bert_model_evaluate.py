...
test_path = "./data/sogou_qa_test.json"


class SquadExample:
    def __init__(self, question_id, question, context, start_char_idx, answer_text, all_answers):
    ...
    for item in raw_data["data"]:
        for para in item["paragraphs"]:
            ...
            for qa in para["qas"]:
                ...
                squad_eg = SquadExample(question_id, question, context, start_char_idx, answer_text, all_answers)
                squad_eg.preprocess()
...
# 模型预测
h = open("qa_pred", "w", encoding="utf-8")
...
for idx, (start, end) in enumerate(zip(pred_start, pred_end)):
    ...
    print(squad_eg.question_id, pred_ans)
    h.write("{}\t{}\n".format(squad_eg.question_id, pred_ans))
