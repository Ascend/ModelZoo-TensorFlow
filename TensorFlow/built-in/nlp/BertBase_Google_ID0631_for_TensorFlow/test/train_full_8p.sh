...
do
    ...
    nohup ${bind_core} python3 run_pretraining.py \
        ...
        --iterations_per_loop=500 > ${cur_path}/output/$ASCEND_DEVICE_ID/train_$ASCEND_DEVICE_ID.log 2>&1 &
done
wait
...
echo "TrainAccuracy = ${masked_lm_accuracy}" >> $cur_path/output/$ASCEND_DEVICE_ID/${CaseName}.log
