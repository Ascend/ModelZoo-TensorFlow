...
class BaseModel(object):
  ...
  def _get_learning_rate_warmup(self, hparams):
    ...
    return tf.cond(
        ...
        lambda:  (tf.exp(tf.log(0.01) / warmup_steps) ** (tf.to_float(warmup_steps - self.global_step)) )* self.learning_rate,
  ...
  def _build_decoder(self, encoder_outputs, encoder_state, hparams):
    ...
    with tf.variable_scope("decoder") as decoder_scope:
      ...
      if self.mode != tf.contrib.learn.ModeKeys.INFER:
        ...
        #logits = tf.contrib.layers.fully_connected(final_rnn_outputs, self.tgt_vocab_size)
      ...
      ## Inference
        ...
        #self.output_layer_temp = tf.contrib.layers.fully_connected(self.tgt_vocab_size)
