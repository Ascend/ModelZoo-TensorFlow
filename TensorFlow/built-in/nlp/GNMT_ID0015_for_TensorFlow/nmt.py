...
def add_arguments(parser):
  ...
  # Misc
  parser.add_argument(
      "--save_checkpoints_steps", type=int, default=6000,
      help="save_checkpoints_steps")
  parser.add_argument(
      "--log_step_count_steps", type=int, default=1,
  ...
  parser.add_argument(
      ...
      choices=("train_and_eval", "train", "infer", "translate"))
  parser.add_argument("--npu_loss_scale", type=int, default=1)
  parser.add_argument("--precision_mode", type=str, default="allow_mix_precision")
  parser.add_argument("--over_dump", type="bool", default=False)
  parser.add_argument("--over_dump_path", type=str, default="")
  parser.add_argument("--data_dump_flag", type="bool", default=False)
  parser.add_argument("--data_dump_step", type=str, default="")
  parser.add_argument("--data_dump_path", type=str, default="")
  parser.add_argument("--profiling", type="bool", default=False)
  parser.add_argument("--profiling_dump_path", type=str, default="")
  parser.add_argument("--autotune", type="bool", default=False)
  parser.add_argument("--use_DynamicRNN", type="bool", default=True)
...
def create_hparams(flags):
  ...
  return tf.contrib.training.HParams(
      ...
      mode=flags.mode,
      npu_loss_scale=flags.npu_loss_scale,
      precision_mode=flags.precision_mode,
      over_dump=flags.over_dump,
      over_dump_path=flags.over_dump_path,
      data_dump_flag=flags.data_dump_flag,
      data_dump_step=flags.data_dump_step,
      data_dump_path=flags.data_dump_path,
      profiling=flags.profiling,
      profiling_dump_path=flags.profiling_dump_path,
      autotune=flags.autotune,
      use_DynamicRNN=flags.use_DynamicRNN,
  )
