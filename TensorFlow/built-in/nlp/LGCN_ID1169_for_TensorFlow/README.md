...
**描述（Description）：基于TensorFlow框架大规模可学习图卷积网络LGCN**

<h2 id="概述.md">概述</h2>

-    大规模可学习图卷积网络为可学习图卷积提供了一种有效的方法（LGCL和LGCN）。

- - 参考论文：

    ```
    https://dl.acm.org/doi/10.1145/3219819.3219947
    ```
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于LGCN_ID1169_for_TensorFlow/test/train_performance_1p.sh），示例如下。
        ...
        2.2 单卡训练指令（脚本位于LGCN_ID1169_for_TensorFlow/test/train_performance_1p.sh） 
