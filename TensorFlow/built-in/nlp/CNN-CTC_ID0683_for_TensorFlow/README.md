...
- 参考实现：
    ...
    [https://github.com/watsonyanghx/CNN_LSTM_CTC_Tensorflow](https://github.com/watsonyanghx/CNN_LSTM_CTC_Tensorflow)
...
- 模型训练使用百度魅族深度学习比赛初赛数据集，数据集请用户自行获取。
- 数据集下载完毕后，请用户使用代码目录下helper.py修改相关路径后生成训练所需文件。
...
- 开始训练。
    ...
    2. 单卡训练
        ...
        2.1 设置单卡训练参数（脚本位于CNN-CTC_ID0683_for_TensorFlow/test/train_full_1p.sh），示例如下。
        ...
        2.2 单卡训练指令（脚本位于CNN-CTC_ID0683_for_TensorFlow/test） 
