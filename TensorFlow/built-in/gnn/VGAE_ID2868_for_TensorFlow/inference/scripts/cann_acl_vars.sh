...
export LD_LIBRARY_PATH=${CANN_TOOLKIT_INSTALL_PATH}/acllib/lib64:${LD_LIBRARY_PATH}
export PYTHONPATH=${CANN_TOOLKIT_INSTALL_PATH}/pyACL/python/site-packages/acl:${PYTHONPATH}
export PYTHONPATH=${CANN_TOOLKIT_INSTALL_PATH}/toolkit/python/site-packages:${PYTHONPATH}
export ASCEND_AICPU_PATH=${CANN_TOOLKIT_INSTALL_PATH}
